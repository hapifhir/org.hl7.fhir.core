...
public class BackboneElement10_40Test {
    private static Stream<Arguments> filesPaths() {
        return Stream.of(
            Arguments.of("/backbone_element_10.json", "/backbone_element_40.json")
         );
    }

    @ParameterizedTest
    @MethodSource("filesPaths")
    @DisplayName("Test 10_40 BackboneElement conversion")
    public void testConversion(String dstu2_path, String stu_path) throws IOException {
        ...
        org.hl7.fhir.r4.model.Resource stu_actual = VersionConvertorFactory_10_40.convertResource(dstu2, new BaseAdvisor_10_40());

        org.hl7.fhir.r4.formats.JsonParser stu_parser = new org.hl7.fhir.r4.formats.JsonParser();
        org.hl7.fhir.r4.model.Resource stu_expected = stu_parser.parse(stu_exepected_input);
