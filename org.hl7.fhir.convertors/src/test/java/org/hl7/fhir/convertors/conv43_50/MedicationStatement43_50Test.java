...
public class MedicationStatement43_50Test {
  ...
  public void testR4_R5_R4_RoundTrip() throws IOException {
    ...
    for (JsonNode r4Json : r4Resources) {
      ...
      // Parse R4 resource
      org.hl7.fhir.r4b.model.MedicationStatement r4_original =
        (org.hl7.fhir.r4b.model.MedicationStatement) new org.hl7.fhir.r4b.formats.JsonParser().parse(r4Json.toString());

      // Convert R4 -> R5
      org.hl7.fhir.r5.model.Resource r5_conv = VersionConvertorFactory_43_50.convertResource(r4_original);
      ...
      // Convert R5 -> R4
      org.hl7.fhir.r4b.model.Resource r4_final = VersionConvertorFactory_43_50.convertResource(r5_streamed);
      org.hl7.fhir.r4b.model.MedicationStatement r4_final_typed = (org.hl7.fhir.r4b.model.MedicationStatement) r4_final;
      ...
      assertTrue(r4_original.getStatusElement().equalsDeep(r4_final_typed.getStatusElement()),
  ...
  public void testR5_R4_R5_RoundTrip() throws IOException {
    ...
    for (JsonNode r5Json : r5Resources) {
      ...
      // Convert R5 -> R4
      org.hl7.fhir.r4b.model.Resource r4_conv = VersionConvertorFactory_43_50.convertResource(r5_original);

      // Serialize and deserialize R4 to ensure serialization works
      org.hl7.fhir.r4b.formats.JsonParser r4_parser = new org.hl7.fhir.r4b.formats.JsonParser();
      ByteArrayOutputStream stream = new ByteArrayOutputStream();
      r4_parser.compose(stream, r4_conv);

      org.hl7.fhir.r4b.model.Resource r4_streamed =
        new org.hl7.fhir.r4b.formats.JsonParser().parse(new ByteArrayInputStream(stream.toByteArray()));

      // Convert R4 -> R5
      org.hl7.fhir.r5.model.Resource r5_final = VersionConvertorFactory_43_50.convertResource(r4_streamed);
  ...
  public void testIndividualR4StatusRoundTrip(String statusCode) throws IOException {
    ...
    for (JsonNode r4Json : r4Resources) {
      if (r4Json.get("status").asText().equals(statusCode)) {
        ...
        // R4 -> R5 -> R4
        org.hl7.fhir.r5.model.Resource r5_conv = VersionConvertorFactory_43_50.convertResource(r4_original);
        org.hl7.fhir.r4b.model.Resource r4_final = VersionConvertorFactory_43_50.convertResource(r5_conv);
        org.hl7.fhir.r4b.model.MedicationStatement r4_final_typed = (org.hl7.fhir.r4b.model.MedicationStatement) r4_final;
  ...
  public void testIndividualR5StatusRoundTrip(String statusCode) throws IOException {
    ...
    for (JsonNode r5Json : r5Resources) {
      if (r5Json.get("status").asText().equals(statusCode)) {
        ...
        // R5 -> R4 -> R5
        org.hl7.fhir.r4b.model.Resource r4_conv = VersionConvertorFactory_43_50.convertResource(r5_original);
        org.hl7.fhir.r5.model.Resource r5_final = VersionConvertorFactory_43_50.convertResource(r4_conv);
        org.hl7.fhir.r5.model.MedicationStatement r5_final_typed = (org.hl7.fhir.r5.model.MedicationStatement) r5_final;
