...
public class Address10_50 {
  public static org.hl7.fhir.r5.model.Address convertAddress(org.hl7.fhir.dstu2.model.Address src) throws FHIRException {
    ...
    if (src.hasPostalCodeElement()) tgt.setPostalCodeElement(String10_50.convertString(src.getPostalCodeElement()));
    if (src.hasCountryElement()) tgt.setCountryElement(String10_50.convertString(src.getCountryElement()));
