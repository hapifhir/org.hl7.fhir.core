...
public class TestScript14_30 {
  ...
  static public org.hl7.fhir.dstu3.model.Enumeration<org.hl7.fhir.dstu3.model.TestScript.ContentType> convertContentType(org.hl7.fhir.dstu2016may.model.Enumeration<org.hl7.fhir.dstu2016may.model.TestScript.ContentType> src) throws FHIRException {
      if (src == null || src.isEmpty())
          return null;
      Enumeration<TestScript.ContentType> tgt = new Enumeration<>(new TestScript.ContentTypeEnumFactory());
      ConversionContext14_30.INSTANCE.getVersionConvertor_14_30().copyElement(src, tgt);
      if (src.getValue() == null) {
          tgt.setValue(null);
      } else {
          switch (src.getValue()) {
              case XML:
                  tgt.setValue(TestScript.ContentType.XML);
                  break;
              case JSON:
                  tgt.setValue(TestScript.ContentType.JSON);
                  break;
              default:
                  tgt.setValue(TestScript.ContentType.NULL);
                  break;
          }
      }
      return tgt;
