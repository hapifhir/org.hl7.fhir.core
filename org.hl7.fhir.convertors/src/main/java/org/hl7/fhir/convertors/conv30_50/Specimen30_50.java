...
public class Specimen30_50 {
    ...
    public static org.hl7.fhir.dstu3.model.Specimen convertSpecimen(org.hl7.fhir.r5.model.Specimen src) throws FHIRException {
        ...
        if (src.hasReceivedTimeElement())
            tgt.setReceivedTimeElement((org.hl7.fhir.dstu3.model.DateTimeType) VersionConvertor_30_50.convertType(src.getReceivedTimeElement()));
        if (src.hasParent()) {
    ...
    public static org.hl7.fhir.r5.model.Specimen convertSpecimen(org.hl7.fhir.dstu3.model.Specimen src) throws FHIRException {
        ...
        if (src.hasSubject())
            tgt.setSubject(VersionConvertor_30_50.convertReference(src.getSubject()));
        if (src.hasReceivedTimeElement())
            tgt.setReceivedTimeElement((org.hl7.fhir.r5.model.DateTimeType) VersionConvertor_30_50.convertType(src.getReceivedTimeElement()));
        if (src.hasParent()) {
    ...
    static public org.hl7.fhir.dstu3.model.Specimen.SpecimenStatus convertSpecimenStatus(org.hl7.fhir.r5.model.Specimen.SpecimenStatus src) throws FHIRException {
        if (src == null)
            return null;
        switch(src) {
            case AVAILABLE:
    ...
    static public org.hl7.fhir.r5.model.Specimen.SpecimenStatus convertSpecimenStatus(org.hl7.fhir.dstu3.model.Specimen.SpecimenStatus src) throws FHIRException {
        if (src == null)
            return null;
        switch(src) {
            case AVAILABLE:
