      ...
      if (src.getValue() == null) {
          ...
          switch (src.getValue()) {
              ...
              case DISPLAY:
                  ...
                  break;
              case QUESTION:
                  tgt.setValue(Questionnaire.QuestionnaireItemType.QUESTION);
                  break;
              case BOOLEAN:
              ...
              case URL:
                  ...
                  break;
              case CHOICE:
                  tgt.setValue(Questionnaire.QuestionnaireItemType.CHOICE);
                  break;
              case OPENCHOICE:
                  tgt.setValue(Questionnaire.QuestionnaireItemType.OPENCHOICE);
                  break;
              case ATTACHMENT:
