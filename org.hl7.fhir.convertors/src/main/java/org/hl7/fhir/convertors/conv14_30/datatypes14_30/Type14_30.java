...
public class Type14_30 {
    public static org.hl7.fhir.dstu3.model.Type convertType(org.hl7.fhir.dstu2016may.model.Type src) throws FHIRException {
      ...
      if (src instanceof org.hl7.fhir.dstu2016may.model.Age) return Age14_30.convertAge((org.hl7.fhir.dstu2016may.model.Age) src);
    ...
    public static org.hl7.fhir.dstu2016may.model.Type convertType(org.hl7.fhir.dstu3.model.Type src) throws FHIRException {
      ...
      if (src instanceof org.hl7.fhir.dstu3.model.CodeType) return Code14_30.convertCode((org.hl7.fhir.dstu3.model.CodeType) src);
      if (src instanceof org.hl7.fhir.dstu3.model.DateType) return Date14_30.convertDate((org.hl7.fhir.dstu3.model.DateType) src);
      ...
      if (src instanceof org.hl7.fhir.dstu3.model.OidType) return Oid14_30.convertOid((org.hl7.fhir.dstu3.model.OidType) src);
      ...
      if (src instanceof org.hl7.fhir.dstu3.model.TimeType) return Time14_30.convertTime((org.hl7.fhir.dstu3.model.TimeType) src);
      ...
      if (src instanceof org.hl7.fhir.dstu3.model.UriType) return Uri14_30.convertUri((org.hl7.fhir.dstu3.model.UriType) src);
      if (src instanceof org.hl7.fhir.dstu3.model.UuidType) return Uuid14_30.convertUuid((org.hl7.fhir.dstu3.model.UuidType) src);
      ...
      if (src instanceof org.hl7.fhir.dstu3.model.Coding) return Code14_30.convertCoding((org.hl7.fhir.dstu3.model.Coding) src);
      if (src instanceof org.hl7.fhir.dstu3.model.Count) return Count14_30.convertCount((org.hl7.fhir.dstu3.model.Count) src);
      ...
      if (src instanceof org.hl7.fhir.dstu3.model.Money) return Money14_30.convertMoney((org.hl7.fhir.dstu3.model.Money) src);
      if (src instanceof org.hl7.fhir.dstu3.model.Period) return Period14_30.convertPeriod((org.hl7.fhir.dstu3.model.Period) src);
      ...
      if (src instanceof org.hl7.fhir.dstu3.model.Range) return Range14_30.convertRange((org.hl7.fhir.dstu3.model.Range) src);
      if (src instanceof org.hl7.fhir.dstu3.model.Ratio) return Ratio14_30.convertRatio((org.hl7.fhir.dstu3.model.Ratio) src);
      ...
      if (src instanceof org.hl7.fhir.dstu3.model.Address) return Address14_30.convertAddress((org.hl7.fhir.dstu3.model.Address) src);
      ...
      if (src instanceof org.hl7.fhir.dstu3.model.Timing) return Timing14_30.convertTiming((org.hl7.fhir.dstu3.model.Timing) src);
      throw new FHIRException("Unknown type " + src.fhirType());
    }
}
