...
public class Parser {
  ...
  public static void main(String[] args) {
    ...
    VERSION_FILES.forEach(version -> {
      ...
      filenames.forEach(name -> {
        cleanAccessorsForFile("/org.hl7.fhir.convertors/src/main/java/org/hl7/fhir/convertors/conv"+version+"/", name, ".java");
      });
    });
    System.out.println();
  }
      ...
      md.accept(new ModifierVisitor<String>() {
        ...
        public Visitable visit(MethodCallExpr n, String arg) {
          ...
          if (n.getTokenRange().toString().contains("src.get")) {
            ...
            String topLevelMethodExpr = getTopLevelMethodExpr(n);
  ...
  private static String getTopLevelMethodExpr(Node exp) {
