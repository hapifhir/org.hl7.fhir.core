...
public class Type30_40 {
    public static org.hl7.fhir.r4.model.Type convertType(org.hl7.fhir.dstu3.model.Type src) throws FHIRException {
      ...
      if (src instanceof org.hl7.fhir.dstu3.model.CodeType) return Code30_40.convertCode((org.hl7.fhir.dstu3.model.CodeType) src);
      if (src instanceof org.hl7.fhir.dstu3.model.DateType) return Date30_40.convertDate((org.hl7.fhir.dstu3.model.DateType) src);
      ...
      if (src instanceof org.hl7.fhir.dstu3.model.OidType) return Oid30_40.convertOid((org.hl7.fhir.dstu3.model.OidType) src);
      ...
      if (src instanceof org.hl7.fhir.dstu3.model.TimeType) return Time30_40.convertTime((org.hl7.fhir.dstu3.model.TimeType) src);
      if (src instanceof org.hl7.fhir.dstu3.model.UuidType) return Uuid30_40.convertUuid((org.hl7.fhir.dstu3.model.UuidType) src);
      if (src instanceof org.hl7.fhir.dstu3.model.UriType) return Uri30_40.convertUri((org.hl7.fhir.dstu3.model.UriType) src);
      ...
      if (src instanceof org.hl7.fhir.dstu3.model.Coding) return Coding30_40.convertCoding((org.hl7.fhir.dstu3.model.Coding) src);
      if (src instanceof org.hl7.fhir.dstu3.model.Count) return Count30_40.convertCount((org.hl7.fhir.dstu3.model.Count) src);
      ...
      if (src instanceof org.hl7.fhir.dstu3.model.Money) return Money30_40.convertMoney((org.hl7.fhir.dstu3.model.Money) src);
      if (src instanceof org.hl7.fhir.dstu3.model.Period) return Period30_40.convertPeriod((org.hl7.fhir.dstu3.model.Period) src);
      ...
      if (src instanceof org.hl7.fhir.dstu3.model.Range) return Range30_40.convertRange((org.hl7.fhir.dstu3.model.Range) src);
      if (src instanceof org.hl7.fhir.dstu3.model.Ratio) return Ratio30_40.convertRatio((org.hl7.fhir.dstu3.model.Ratio) src);
      ...
      if (src instanceof org.hl7.fhir.dstu3.model.Address) return Address30_40.convertAddress((org.hl7.fhir.dstu3.model.Address) src);
      ...
      if (src instanceof org.hl7.fhir.dstu3.model.Dosage) return Dosage30_40.convertDosage((org.hl7.fhir.dstu3.model.Dosage) src);
      ...
      if (src instanceof org.hl7.fhir.dstu3.model.Timing) return Timing30_40.convertTiming((org.hl7.fhir.dstu3.model.Timing) src);
    ...
    public static org.hl7.fhir.dstu3.model.Type convertType(org.hl7.fhir.r4.model.Type src) throws FHIRException {
      ...
      if (src instanceof org.hl7.fhir.r4.model.CodeType) return Code30_40.convertCode((org.hl7.fhir.r4.model.CodeType) src);
      if (src instanceof org.hl7.fhir.r4.model.DateType) return Date30_40.convertDate((org.hl7.fhir.r4.model.DateType) src);
      ...
      if (src instanceof org.hl7.fhir.r4.model.StringType) return String30_40.convertString((org.hl7.fhir.r4.model.StringType) src);
      if (src instanceof org.hl7.fhir.r4.model.TimeType) return Time30_40.convertTime((org.hl7.fhir.r4.model.TimeType) src);
      if (src instanceof org.hl7.fhir.r4.model.UuidType) return Uuid30_40.convertUuid((org.hl7.fhir.r4.model.UuidType) src);
      if (src instanceof org.hl7.fhir.r4.model.UriType) return Uri30_40.convertUri((org.hl7.fhir.r4.model.UriType) src);
      if (src instanceof org.hl7.fhir.r4.model.Extension) return Extension30_40.convertExtension((org.hl7.fhir.r4.model.Extension) src);
      if (src instanceof org.hl7.fhir.r4.model.Narrative) return Narrative30_40.convertNarrative((org.hl7.fhir.r4.model.Narrative) src);
      ...
      if (src instanceof org.hl7.fhir.r4.model.Coding) return Coding30_40.convertCoding((org.hl7.fhir.r4.model.Coding) src);
      if (src instanceof org.hl7.fhir.r4.model.Count) return Count30_40.convertCount((org.hl7.fhir.r4.model.Count) src);
      if (src instanceof org.hl7.fhir.r4.model.Distance) return Distance30_40.convertDistance((org.hl7.fhir.r4.model.Distance) src);
      if (src instanceof org.hl7.fhir.r4.model.Duration) return Duration30_40.convertDuration((org.hl7.fhir.r4.model.Duration) src);
      ...
      if (src instanceof org.hl7.fhir.r4.model.Period) return Period30_40.convertPeriod((org.hl7.fhir.r4.model.Period) src);
      ...
      if (src instanceof org.hl7.fhir.r4.model.Quantity) return Quantity30_40.convertQuantity((org.hl7.fhir.r4.model.Quantity) src);
      ...
      if (src instanceof org.hl7.fhir.r4.model.Reference) return Reference30_40.convertReference((org.hl7.fhir.r4.model.Reference) src);
      ...
      if (src instanceof org.hl7.fhir.r4.model.Signature) return Signature30_40.convertSignature((org.hl7.fhir.r4.model.Signature) src);
      if (src instanceof org.hl7.fhir.r4.model.Address) return Address30_40.convertAddress((org.hl7.fhir.r4.model.Address) src);
      ...
      if (src instanceof org.hl7.fhir.r4.model.Dosage) return Dosage30_40.convertDosage((org.hl7.fhir.r4.model.Dosage) src);
      if (src instanceof org.hl7.fhir.r4.model.HumanName) return HumanName30_40.convertHumanName((org.hl7.fhir.r4.model.HumanName) src);
      ...
      if (src instanceof org.hl7.fhir.r4.model.Timing) return Timing30_40.convertTiming((org.hl7.fhir.r4.model.Timing) src);
