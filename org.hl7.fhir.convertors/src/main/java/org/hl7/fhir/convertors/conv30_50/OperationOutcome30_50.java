...
public class OperationOutcome30_50 {
    ...
    static public org.hl7.fhir.dstu3.model.OperationOutcome.IssueSeverity convertIssueSeverity(org.hl7.fhir.r5.model.OperationOutcome.IssueSeverity src) throws FHIRException {
        if (src == null)
            return null;
        switch(src) {
            case FATAL:
    ...
    static public org.hl7.fhir.r5.model.OperationOutcome.IssueSeverity convertIssueSeverity(org.hl7.fhir.dstu3.model.OperationOutcome.IssueSeverity src) throws FHIRException {
        if (src == null)
            return null;
        switch(src) {
            case FATAL:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueSeverity.FATAL;
            case ERROR:
            ...
            default:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueSeverity.NULL;
        }
    }

    static public org.hl7.fhir.r5.model.OperationOutcome.IssueType convertIssueType(org.hl7.fhir.dstu3.model.OperationOutcome.IssueType src) throws FHIRException {
        if (src == null)
            return null;
        switch(src) {
            case INVALID:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.INVALID;
            case STRUCTURE:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.STRUCTURE;
            case REQUIRED:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.REQUIRED;
            case VALUE:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.VALUE;
            case INVARIANT:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.INVARIANT;
            case SECURITY:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.SECURITY;
            case LOGIN:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.LOGIN;
            case UNKNOWN:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.UNKNOWN;
            case EXPIRED:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.EXPIRED;
            case FORBIDDEN:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.FORBIDDEN;
            case SUPPRESSED:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.SUPPRESSED;
            case PROCESSING:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.PROCESSING;
            case NOTSUPPORTED:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.NOTSUPPORTED;
            case DUPLICATE:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.DUPLICATE;
            case NOTFOUND:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.NOTFOUND;
            case TOOLONG:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.TOOLONG;
            case CODEINVALID:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.CODEINVALID;
            case EXTENSION:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.EXTENSION;
            case TOOCOSTLY:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.TOOCOSTLY;
            case BUSINESSRULE:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.BUSINESSRULE;
            case CONFLICT:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.CONFLICT;
            case INCOMPLETE:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.INCOMPLETE;
            case TRANSIENT:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.TRANSIENT;
            case LOCKERROR:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.LOCKERROR;
            case NOSTORE:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.NOSTORE;
            case EXCEPTION:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.EXCEPTION;
            case TIMEOUT:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.TIMEOUT;
            case THROTTLED:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.THROTTLED;
            case INFORMATIONAL:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.INFORMATIONAL;
            default:
                return org.hl7.fhir.r5.model.OperationOutcome.IssueType.NULL;
        }
    }

    static public org.hl7.fhir.dstu3.model.OperationOutcome.IssueType convertIssueType(org.hl7.fhir.r5.model.OperationOutcome.IssueType src) throws FHIRException {
        if (src == null)
            return null;
        switch(src) {
            case INVALID:
