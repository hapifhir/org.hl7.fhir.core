...
public class Type10_40 {
    public static org.hl7.fhir.r4.model.Type convertType(org.hl7.fhir.dstu2.model.Type src) throws FHIRException {
      ...
      if (src instanceof org.hl7.fhir.dstu2.model.OidType) return Oid10_40.convertOid((org.hl7.fhir.dstu2.model.OidType) src);
      ...
      if (src instanceof org.hl7.fhir.dstu2.model.UriType) return Uri10_40.convertUri((org.hl7.fhir.dstu2.model.UriType) src);
      ...
      if (src instanceof org.hl7.fhir.dstu2.model.Coding) return Coding10_40.convertCoding((org.hl7.fhir.dstu2.model.Coding) src);
      ...
      if (src instanceof org.hl7.fhir.dstu2.model.Period) return Period10_40.convertPeriod((org.hl7.fhir.dstu2.model.Period) src);
      ...
      if (src instanceof org.hl7.fhir.dstu2.model.Range) return Range10_40.convertRange((org.hl7.fhir.dstu2.model.Range) src);
      if (src instanceof org.hl7.fhir.dstu2.model.Ratio) return Ratio10_40.convertRatio((org.hl7.fhir.dstu2.model.Ratio) src);
      ...
      if (src instanceof org.hl7.fhir.dstu2.model.Timing) return Timing10_40.convertTiming((org.hl7.fhir.dstu2.model.Timing) src);
      if (src instanceof org.hl7.fhir.dstu2.model.Age) return Age10_40.convertAge((org.hl7.fhir.dstu2.model.Age) src);
      if (src instanceof org.hl7.fhir.dstu2.model.Count) return Count10_40.convertCount((org.hl7.fhir.dstu2.model.Count) src);
      ...
      if (src instanceof org.hl7.fhir.dstu2.model.Money) return Money10_40.convertMoney((org.hl7.fhir.dstu2.model.Money) src);
    ...
    public static org.hl7.fhir.dstu2.model.Type convertType(org.hl7.fhir.r4.model.Type src) throws FHIRException {
      ...
      if (src instanceof org.hl7.fhir.r4.model.CodeType) return Code10_40.convertCode((org.hl7.fhir.r4.model.CodeType) src);
      if (src instanceof org.hl7.fhir.r4.model.DateType) return Date10_40.convertDate((org.hl7.fhir.r4.model.DateType) src);
      ...
      if (src instanceof org.hl7.fhir.r4.model.TimeType) return Time10_40.convertTime((org.hl7.fhir.r4.model.TimeType) src);
      ...
      if (src instanceof org.hl7.fhir.r4.model.UuidType) return Uuid10_40.convertUuid((org.hl7.fhir.r4.model.UuidType) src);
      ...
      if (src instanceof org.hl7.fhir.r4.model.Coding) return Coding10_40.convertCoding((org.hl7.fhir.r4.model.Coding) src);
      ...
      if (src instanceof org.hl7.fhir.r4.model.Period) return Period10_40.convertPeriod((org.hl7.fhir.r4.model.Period) src);
      if (src instanceof org.hl7.fhir.r4.model.Quantity) return Quantity10_40.convertQuantity((org.hl7.fhir.r4.model.Quantity) src);
      ...
      if (src instanceof org.hl7.fhir.r4.model.Address) return Address10_40.convertAddress((org.hl7.fhir.r4.model.Address) src);
      ...
      if (src instanceof org.hl7.fhir.r4.model.Timing) return Timing10_40.convertTiming((org.hl7.fhir.r4.model.Timing) src);
      ...
      if (src instanceof org.hl7.fhir.r4.model.Distance) return Distance10_40.convertDistance((org.hl7.fhir.r4.model.Distance) src);
      if (src instanceof org.hl7.fhir.r4.model.Duration) return Duration10_40.convertDuration((org.hl7.fhir.r4.model.Duration) src);
