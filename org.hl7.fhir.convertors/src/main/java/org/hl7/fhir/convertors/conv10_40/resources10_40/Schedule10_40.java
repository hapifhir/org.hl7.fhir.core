...
public class Schedule10_40 {
    ...
    public static org.hl7.fhir.r4.model.Schedule convertSchedule(org.hl7.fhir.dstu2.model.Schedule src) throws FHIRException {
        ...
        for (org.hl7.fhir.dstu2.model.CodeableConcept t : src.getType()) tgt.addServiceType(CodeableConcept10_40.convertCodeableConcept(t));
        if (src.hasActor())
    ...
    public static org.hl7.fhir.dstu2.model.Schedule convertSchedule(org.hl7.fhir.r4.model.Schedule src) throws FHIRException {
        ...
        for (org.hl7.fhir.r4.model.CodeableConcept t : src.getServiceType()) tgt.addType(CodeableConcept10_40.convertCodeableConcept(t));
        if (src.hasActor())
