...
public class Conformance10_50 {
  ...
  public static org.hl7.fhir.dstu2.model.Conformance convertConformance(org.hl7.fhir.r5.model.CapabilityStatement src, BaseAdvisor_10_50 advisor) throws FHIRException {
    ...
    if (src.hasExtension(VersionConvertorConstants.EXT_ACCEPT_UNKNOWN_EXTENSION_URL))
      tgt.setAcceptUnknown(org.hl7.fhir.dstu2.model.Conformance.UnknownContentCode.fromCode(src.getExtensionByUrl(VersionConvertorConstants.EXT_ACCEPT_UNKNOWN_EXTENSION_URL).getValue().primitiveValue()));
    ...
    for (CapabilityStatementRestComponent r : src.getRest())
      for (CapabilityStatementRestResourceComponent rr : r.getResource())
        for (org.hl7.fhir.r5.model.CanonicalType t : rr.getSupportedProfile())
          tgt.addProfile(Reference10_50.convertCanonicalToReference(t));
  ...
  public static org.hl7.fhir.dstu2.model.Conformance.ConformanceMessagingComponent convertConformanceMessagingComponent(org.hl7.fhir.r5.model.CapabilityStatement.CapabilityStatementMessagingComponent src) throws FHIRException {
    ...
    if (src.hasReliableCacheElement())
      tgt.setReliableCacheElement(UnsignedInt10_50.convertUnsignedInt(src.getReliableCacheElement()));
    if (src.hasDocumentation())
      tgt.setDocumentation(src.getDocumentation());
    for (org.hl7.fhir.r5.model.Extension e : src.getExtensionsByUrl(VersionConvertorConstants.EXT_IG_CONFORMANCE_MESSAGE_EVENT)) {
      ...
      tgt.addEvent(event);
      event.setCode(Coding10_50.convertCoding((org.hl7.fhir.r5.model.Coding) e.getExtensionByUrl("code").getValue()));
      ...
      if (focusE.getValue().hasPrimitiveValue())
        ...
        ConversionContext10_50.INSTANCE.getVersionConvertor_10_50().copyElement(focusE.getValue(), event.getFocusElement());
      }
      event.setRequest(Reference10_50.convertReference((org.hl7.fhir.r5.model.Reference) e.getExtensionByUrl("request").getValue()));
      event.setResponse(Reference10_50.convertReference((org.hl7.fhir.r5.model.Reference) e.getExtensionByUrl("response").getValue()));
  ...
  public static org.hl7.fhir.r5.model.CapabilityStatement.CapabilityStatementMessagingComponent convertConformanceMessagingComponent(org.hl7.fhir.dstu2.model.Conformance.ConformanceMessagingComponent src) throws FHIRException {
    ...
    for (org.hl7.fhir.dstu2.model.Conformance.ConformanceMessagingEventComponent t : src.getEvent()) {
      ...
      e.addExtension(new org.hl7.fhir.r5.model.Extension("code", Coding10_50.convertCoding(t.getCode())));
      if (t.hasCategory())
      ...
      if (t.getFocusElement().hasValue())
        ...
        ConversionContext10_50.INSTANCE.getVersionConvertor_10_50().copyElement(t.getFocusElement(), focus);
        e.addExtension(focusE);
      }
      e.addExtension(new org.hl7.fhir.r5.model.Extension("request", Reference10_50.convertReference(t.getRequest())));
      e.addExtension(new org.hl7.fhir.r5.model.Extension("response", Reference10_50.convertReference(t.getResponse())));
  ...
  public static org.hl7.fhir.r5.model.CapabilityStatement.CapabilityStatementMessagingEndpointComponent convertConformanceMessagingEndpointComponent(org.hl7.fhir.dstu2.model.Conformance.ConformanceMessagingEndpointComponent src) throws FHIRException {
    ...
    ConversionContext10_50.INSTANCE.getVersionConvertor_10_50().copyBackboneElement(src,tgt);
    if (src.hasProtocol())
      tgt.setProtocol(Coding10_50.convertCoding(src.getProtocol()));
    if (src.hasAddress())
  ...
  public static org.hl7.fhir.dstu2.model.Conformance.ConformanceRestOperationComponent convertConformanceRestOperationComponent(org.hl7.fhir.r5.model.CapabilityStatement.CapabilityStatementRestResourceOperationComponent src) throws FHIRException {
    ...
    if (src.hasDefinitionElement())
      tgt.setDefinition(Reference10_50.convertCanonicalToReference(src.getDefinitionElement()));
    return tgt;
  }
  ...
  public static org.hl7.fhir.r5.model.CapabilityStatement.CapabilityStatementRestResourceOperationComponent convertConformanceRestOperationComponent(org.hl7.fhir.dstu2.model.Conformance.ConformanceRestOperationComponent src) throws FHIRException {
    ...
    if (src.hasDefinition())
      tgt.setDefinitionElement(Reference10_50.convertReferenceToCanonical(src.getDefinition()));
    return tgt;
  }
  ...
  public static org.hl7.fhir.r5.model.CapabilityStatement.CapabilityStatementRestResourceComponent convertConformanceRestResourceComponent(org.hl7.fhir.dstu2.model.Conformance.ConformanceRestResourceComponent src) throws FHIRException {
    ...
    if (src.hasReadHistoryElement())
      tgt.setReadHistoryElement(Boolean10_50.convertBoolean(src.getReadHistoryElement()));
    if (src.hasUpdateCreateElement())
      tgt.setUpdateCreateElement(Boolean10_50.convertBoolean(src.getUpdateCreateElement()));
    if (src.hasConditionalCreateElement())
      tgt.setConditionalCreateElement(Boolean10_50.convertBoolean(src.getConditionalCreateElement()));
    if (src.hasConditionalUpdateElement())
      tgt.setConditionalUpdateElement(Boolean10_50.convertBoolean(src.getConditionalUpdateElement()));
  ...
  public static org.hl7.fhir.r5.model.CapabilityStatement.CapabilityStatementRestSecurityComponent convertConformanceRestSecurityComponent(org.hl7.fhir.dstu2.model.Conformance.ConformanceRestSecurityComponent src) throws FHIRException {
    ...
    if (src.hasCorsElement())
      tgt.setCorsElement(Boolean10_50.convertBoolean(src.getCorsElement()));
    for (org.hl7.fhir.dstu2.model.CodeableConcept t : src.getService())
      tgt.addService(CodeableConcept10_50.convertCodeableConcept(t));
    if (src.hasDescription())
      tgt.setDescription(src.getDescription());
    return tgt;
  }
  ...
  public static org.hl7.fhir.dstu2.model.Conformance.ConformanceSoftwareComponent convertConformanceSoftwareComponent(org.hl7.fhir.r5.model.CapabilityStatement.CapabilityStatementSoftwareComponent src) throws FHIRException {
    ...
    if (src.hasReleaseDateElement())
      tgt.setReleaseDateElement(DateTime10_50.convertDateTime(src.getReleaseDateElement()));
    return tgt;
  }
  ...
  static public org.hl7.fhir.r5.model.Enumeration<org.hl7.fhir.r5.model.CapabilityStatement.SystemRestfulInteraction> convertSystemRestfulInteraction(org.hl7.fhir.dstu2.model.Enumeration<org.hl7.fhir.dstu2.model.Conformance.SystemRestfulInteraction> src) throws FHIRException {
      if (src == null || src.isEmpty())
          return null;
      org.hl7.fhir.r5.model.Enumeration<SystemRestfulInteraction> tgt = new org.hl7.fhir.r5.model.Enumeration<>(new CapabilityStatement.SystemRestfulInteractionEnumFactory());
      ConversionContext10_50.INSTANCE.getVersionConvertor_10_50().copyElement(src, tgt);
      if (src.getValue() == null) {
          tgt.setValue(null);
      } else {
