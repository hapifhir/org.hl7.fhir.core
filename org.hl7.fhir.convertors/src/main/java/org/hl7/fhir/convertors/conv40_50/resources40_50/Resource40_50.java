...
//      return DocumentManifest40_50.convertDocumentManifest((org.hl7.fhir.r5.model.DocumentManifest) src);
  ...
  public void copyDomainResource(org.hl7.fhir.r4.model.DomainResource src, org.hl7.fhir.r5.model.DomainResource tgt, String... ignoredExtensionUrls) throws FHIRException {
    ...
    src.getExtension().forEach(extension -> {
      ...
      } else if (!advisor.ignoreExtension(ConversionContext40_50.INSTANCE.path(), extension) && !Arrays.asList(ignoredExtensionUrls).contains(extension.getUrl())) {
  ...
  public void copyDomainResource(org.hl7.fhir.r5.model.DomainResource src, org.hl7.fhir.r4.model.DomainResource tgt,  String... ignoredExtensionUrls) throws FHIRException {
    copyResource(src, tgt);
    if (src.hasText()) tgt.setText(Narrative40_50.convertNarrative(src.getText()));
    src.getContained().stream()
      .map(this::convertResource)
