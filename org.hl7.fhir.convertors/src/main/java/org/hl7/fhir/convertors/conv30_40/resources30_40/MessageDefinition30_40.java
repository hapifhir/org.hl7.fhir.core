...
public class MessageDefinition30_40 {
    ...
    public static org.hl7.fhir.dstu3.model.MessageDefinition convertMessageDefinition(org.hl7.fhir.r4.model.MessageDefinition src) throws FHIRException {
        ...
        for (org.hl7.fhir.r4.model.CanonicalType t : src.getParent()) tgt.addParent(Reference30_40.convertCanonicalToReference(t));
        for (org.hl7.fhir.r4.model.CanonicalType t : src.getReplaces()) tgt.addReplaces(Reference30_40.convertCanonicalToReference(t));
    ...
    public static org.hl7.fhir.r4.model.MessageDefinition convertMessageDefinition(org.hl7.fhir.dstu3.model.MessageDefinition src) throws FHIRException {
        ...
        for (org.hl7.fhir.dstu3.model.Reference t : src.getParent()) tgt.getParent().add(Reference30_40.convertReferenceToCanonical(t));
        for (org.hl7.fhir.dstu3.model.Reference t : src.getReplaces()) tgt.getReplaces().add(Reference30_40.convertReferenceToCanonical(t));
        if (src.hasEvent())
