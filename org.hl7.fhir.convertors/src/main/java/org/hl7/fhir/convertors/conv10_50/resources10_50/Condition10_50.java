...
public class Condition10_50 {
    ...
    public static org.hl7.fhir.dstu2.model.Condition convertCondition(org.hl7.fhir.r5.model.Condition src) throws FHIRException {
        ...
        for (org.hl7.fhir.r5.model.CodeableConcept t : src.getCategory()) tgt.setCategory(CodeableConcept10_50.convertCodeableConcept(t));
        ...
        if (src.hasOnset())
            tgt.setOnset(Type10_50.convertType(src.getOnset()));
        if (src.hasAbatement())
            tgt.setAbatement(Type10_50.convertType(src.getAbatement()));
        if (src.hasStage())
        ...
        for (org.hl7.fhir.r5.model.CodeableConcept t : src.getBodySite()) tgt.addBodySite(CodeableConcept10_50.convertCodeableConcept(t));
        return tgt;
    }
    ...
    public static org.hl7.fhir.r5.model.Condition convertCondition(org.hl7.fhir.dstu2.model.Condition src) throws FHIRException {
        ...
        for (org.hl7.fhir.dstu2.model.CodeableConcept t : src.getBodySite()) tgt.addBodySite(CodeableConcept10_50.convertCodeableConcept(t));
        return tgt;
    }
    ...
    public static org.hl7.fhir.dstu2.model.Condition.ConditionEvidenceComponent convertConditionEvidenceComponent(org.hl7.fhir.r5.model.Condition.ConditionEvidenceComponent src) throws FHIRException {
        ...
        for (org.hl7.fhir.r5.model.CodeableConcept cc : src.getCode()) tgt.setCode(CodeableConcept10_50.convertCodeableConcept(cc));
    ...
    public static org.hl7.fhir.r5.model.Condition.ConditionStageComponent convertConditionStageComponent(org.hl7.fhir.dstu2.model.Condition.ConditionStageComponent src) throws FHIRException {
        ...
        if (src.hasSummary())
            tgt.setSummary(CodeableConcept10_50.convertCodeableConcept(src.getSummary()));
        for (org.hl7.fhir.dstu2.model.Reference t : src.getAssessment()) tgt.addAssessment(Reference10_50.convertReference(t));
        return tgt;
    }
