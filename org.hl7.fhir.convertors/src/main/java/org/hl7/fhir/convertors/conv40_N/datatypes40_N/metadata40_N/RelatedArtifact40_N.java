...
public class RelatedArtifact40_N {
  public static org.hl7.fhir.model.core.RelatedArtifact convertRelatedArtifact(org.hl7.fhir.r4.model.RelatedArtifact src) throws FHIRException {
    ...
    if (src.hasCitation()) tgt.setCitationElement(MarkDown40_N.convertMarkdown(src.getCitationElement()));
    if (src.hasUrl()) tgt.getDocument().setUrlElement(Url40_N.convertUrl(src.getUrlElement()));
    if (src.hasDocument()) tgt.setDocument(Attachment40_N.convertAttachment(src.getDocument()));
    if (src.hasResource()) tgt.setResourceElement(Canonical40_N.convertCanonical(src.getResourceElement()));
    return tgt;
  }

  public static org.hl7.fhir.r4.model.RelatedArtifact convertRelatedArtifact(org.hl7.fhir.model.core.RelatedArtifact src) throws FHIRException {
    if (src == null) return null;
    ...
    if (src.hasDisplay()) tgt.setDisplayElement(String40_N.convertString(src.getDisplayElement()));
    if (src.hasCitation()) tgt.setCitationElement(MarkDown40_N.convertMarkdown(src.getCitationElement()));
    if (src.getDocument().hasUrl()) tgt.setUrlElement(Url40_N.convertUrl(src.getDocument().getUrlElement()));
    if (src.hasDocument()) tgt.setDocument(Attachment40_N.convertAttachment(src.getDocument()));
    if (src.hasResource()) tgt.setResourceElement(Canonical40_N.convertCanonical(src.getResourceElement()));
    return tgt;
  }

  static public org.hl7.fhir.model.core.Enumeration<org.hl7.fhir.model.core.RelatedArtifact.RelatedArtifactType> convertRelatedArtifactType(org.hl7.fhir.r4.model.Enumeration<org.hl7.fhir.r4.model.RelatedArtifact.RelatedArtifactType> src) throws FHIRException {
  ...
  static public org.hl7.fhir.r4.model.Enumeration<org.hl7.fhir.r4.model.RelatedArtifact.RelatedArtifactType> convertRelatedArtifactType(org.hl7.fhir.model.core.Enumeration<org.hl7.fhir.model.core.RelatedArtifact.RelatedArtifactType> src) throws FHIRException {
    if (src == null || src.isEmpty()) return null;
