...
public class TestReport30_50 {
    ...
    public static org.hl7.fhir.dstu3.model.TestReport convertTestReport(org.hl7.fhir.r5.model.TestReport src) throws FHIRException {
        ...
        if (src.hasScore())
            tgt.setScoreElement(VersionConvertor_30_50.convertDecimal(src.getScoreElement()));
        if (src.hasTester())
            tgt.setTesterElement(VersionConvertor_30_50.convertString(src.getTesterElement()));
        if (src.hasIssued())
            tgt.setIssuedElement(VersionConvertor_30_50.convertDateTime(src.getIssuedElement()));
