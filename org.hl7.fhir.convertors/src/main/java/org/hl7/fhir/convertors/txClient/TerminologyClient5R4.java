...
public class TerminologyClient5R4 implements ITerminologyClient5 {


  public static class TerminologyClientR4Factory implements ITerminologyClientFactory5 {
    ...
    public ITerminologyClient5 makeClientR5(String id, String url, String userAgent, ToolingClientLogger logger) throws URISyntaxException {
      return new TerminologyClient5R4(id, checkEndsWith("/r4", url), userAgent);
    }
  ...
  public TerminologyClient5R4(String id, String address, String userAgent) throws URISyntaxException {
    this.client = new FHIRToolingClient(address, userAgent);
    setClientHeaders(new ClientHeaders());
    this.id = id;
  }

  public TerminologyClient5R4(String id, String address, String userAgent, ClientHeaders clientHeaders) throws URISyntaxException {
    this.client = new FHIRToolingClient(address, userAgent);
  ...
  @Override
  public ITerminologyClient5 setTimeoutFactor(int i) {
  ...
  @Override
  public ITerminologyClient5 setLogger(ToolingClientLogger txLog) {
    client.setLogger(txLog);
    return this;
  }

  @Override
  public ITerminologyClient5 setRetryCount(int retryCount) throws FHIRException {
    client.setRetryCount(retryCount);
    return this;
  }

  @Override
  public ITerminologyClient5 setFormat(ResourceFormat fmt) throws FHIRException {
  ...
  @Override
  public ITerminologyClient5 setRequestIdProvider(ITerminologyRequestIdProvider provider) throws FHIRException {
  ...
  public CanonicalResource read(String type, String id) {
    ...
    org.hl7.fhir.r5.model.Resource r5 = convertResource("read", "response", r4);
    if (r5 == null) {
  ...
  @Override
  public ITerminologyClient5 setClientHeaders(ClientHeaders clientHeaders) {
  ...
  @Override
  public ITerminologyClient5 addClientHeader(HTTPHeader header) {
    if (this.clientHeaders == null) {
  ...
  @Override
  public ITerminologyClient5 setUserAgent(String userAgent) {
  ...
  @Override
  public ITerminologyClient5 setAcceptLanguage(String lang) {
    client.setAcceptLanguage(lang);
    return this;
  }
  
  @Override
  public ITerminologyClient5 setContentLanguage(String lang) {
  ...
  private org.hl7.fhir.r4.model.Resource convertResource(String name, String mode, org.hl7.fhir.r5.model.Resource resource) {
    if (logger != null) {
      try {
        logger.log(name, mode, resource.fhirType(), "r5", new org.hl7.fhir.r5.formats.JsonParser().setOutputStyle(OutputStyle.PRETTY).composeBytes(resource));
      } catch (IOException e) {
        throw new FHIRException(e);
      }
    }
  ...
  private org.hl7.fhir.r5.model.Resource convertResource(String name, String mode, org.hl7.fhir.r4.model.Resource resource) {
    ...
    if (logger != null && name != null) {
      try {
        logger.log(name, mode, resource.fhirType(), "r5", new org.hl7.fhir.r5.formats.JsonParser().setOutputStyle(OutputStyle.PRETTY).composeBytes(res));
      } catch (IOException e) {
        throw new FHIRException(e);
      }
    }
