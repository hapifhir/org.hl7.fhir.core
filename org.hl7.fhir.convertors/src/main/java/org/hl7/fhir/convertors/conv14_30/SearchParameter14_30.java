...
public class SearchParameter14_30 {
    ...
    public static org.hl7.fhir.dstu2016may.model.SearchParameter convertSearchParameter(org.hl7.fhir.dstu3.model.SearchParameter src) throws FHIRException {
        ...
        if (src.hasExpressionElement())
            tgt.setExpressionElement((org.hl7.fhir.dstu2016may.model.StringType) VersionConvertor_14_30.convertType(src.getExpressionElement()));
        if (src.hasXpathElement())
            tgt.setXpathElement((org.hl7.fhir.dstu2016may.model.StringType) VersionConvertor_14_30.convertType(src.getXpathElement()));
    ...
    public static org.hl7.fhir.dstu3.model.SearchParameter convertSearchParameter(org.hl7.fhir.dstu2016may.model.SearchParameter src) throws FHIRException {
        ...
        if (src.hasBaseElement())
            tgt.setBase(Collections.singletonList((org.hl7.fhir.dstu3.model.CodeType) VersionConvertor_14_30.convertType(src.getBaseElement())));
        if (src.hasType()) {
            tgt.setType(VersionConvertor_14_30.convertSearchParamType(src.getType()));
        }
        if (src.hasDescriptionElement())
        ...
        if (src.hasExpressionElement())
            tgt.setExpressionElement((org.hl7.fhir.dstu3.model.StringType) VersionConvertor_14_30.convertType(src.getExpressionElement()));
        if (src.hasXpathElement())
            tgt.setXpathElement((org.hl7.fhir.dstu3.model.StringType) VersionConvertor_14_30.convertType(src.getXpathElement()));
        if (src.hasXpathUsage()) {
            tgt.setXpathUsage(convertXPathUsageType(src.getXpathUsage()));
        }
        if (src.hasTarget()) {
