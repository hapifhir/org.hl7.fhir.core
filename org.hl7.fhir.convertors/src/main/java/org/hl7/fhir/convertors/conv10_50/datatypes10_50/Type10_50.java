...
public class Type10_50 {
    public static org.hl7.fhir.r5.model.DataType convertType(org.hl7.fhir.dstu2.model.Type src) throws FHIRException {
      ...
      if (src instanceof org.hl7.fhir.dstu2.model.OidType) return Oid10_50.convertOid((org.hl7.fhir.dstu2.model.OidType) src);
      ...
      if (src instanceof org.hl7.fhir.dstu2.model.UriType) return Uri10_50.convertUri((org.hl7.fhir.dstu2.model.UriType) src);
      ...
      if (src instanceof org.hl7.fhir.dstu2.model.Coding) return Coding10_50.convertCoding((org.hl7.fhir.dstu2.model.Coding) src);
      ...
      if (src instanceof org.hl7.fhir.dstu2.model.Period) return Period10_50.convertPeriod((org.hl7.fhir.dstu2.model.Period) src);
      ...
      if (src instanceof org.hl7.fhir.dstu2.model.Range) return Range10_50.convertRange((org.hl7.fhir.dstu2.model.Range) src);
      if (src instanceof org.hl7.fhir.dstu2.model.Ratio) return Ratio10_50.convertRatio((org.hl7.fhir.dstu2.model.Ratio) src);
      ...
      if (src instanceof org.hl7.fhir.dstu2.model.Timing) return Timing10_50.convertTiming((org.hl7.fhir.dstu2.model.Timing) src);
      if (src instanceof org.hl7.fhir.dstu2.model.Age) return Age10_50.convertAge((org.hl7.fhir.dstu2.model.Age) src);
      if (src instanceof org.hl7.fhir.dstu2.model.Count) return Count10_50.convertCount((org.hl7.fhir.dstu2.model.Count) src);
      ...
      if (src instanceof org.hl7.fhir.dstu2.model.Money) return Money10_50.convertMoney((org.hl7.fhir.dstu2.model.Money) src);
    ...
    public static org.hl7.fhir.dstu2.model.Type convertType(org.hl7.fhir.r5.model.DataType src) throws FHIRException {
      ...
      if (src instanceof org.hl7.fhir.r5.model.CodeType) return Code10_50.convertCode((org.hl7.fhir.r5.model.CodeType) src);
      if (src instanceof org.hl7.fhir.r5.model.DateType) return Date10_50.convertDate((org.hl7.fhir.r5.model.DateType) src);
      ...
      if (src instanceof org.hl7.fhir.r5.model.TimeType) return Time10_50.convertTime((org.hl7.fhir.r5.model.TimeType) src);
      ...
      if (src instanceof org.hl7.fhir.r5.model.UuidType) return Uuid10_50.convertUuid((org.hl7.fhir.r5.model.UuidType) src);
      ...
      if (src instanceof org.hl7.fhir.r5.model.Coding) return Coding10_50.convertCoding((org.hl7.fhir.r5.model.Coding) src);
      ...
      if (src instanceof org.hl7.fhir.r5.model.Period) return Period10_50.convertPeriod((org.hl7.fhir.r5.model.Period) src);
      if (src instanceof org.hl7.fhir.r5.model.Quantity) return Quantity10_50.convertQuantity((org.hl7.fhir.r5.model.Quantity) src);
      ...
      if (src instanceof org.hl7.fhir.r5.model.Address) return Address10_50.convertAddress((org.hl7.fhir.r5.model.Address) src);
      ...
      if (src instanceof org.hl7.fhir.r5.model.Timing) return Timing10_50.convertTiming((org.hl7.fhir.r5.model.Timing) src);
      ...
      if (src instanceof org.hl7.fhir.r5.model.Distance) return Distance10_50.convertDistance((org.hl7.fhir.r5.model.Distance) src);
      if (src instanceof org.hl7.fhir.r5.model.Duration) return Duration10_50.convertDuration((org.hl7.fhir.r5.model.Duration) src);
