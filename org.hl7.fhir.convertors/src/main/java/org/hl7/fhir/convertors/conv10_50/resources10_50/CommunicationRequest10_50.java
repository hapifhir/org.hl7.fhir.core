...
public class CommunicationRequest10_50 {
    ...
    public static org.hl7.fhir.dstu2.model.CommunicationRequest convertCommunicationRequest(org.hl7.fhir.r5.model.CommunicationRequest src) throws FHIRException {
        ...
        if (src.hasOccurrence())
            tgt.setScheduled(Type10_50.convertType(src.getOccurrence()));
    ...
    public static org.hl7.fhir.r5.model.CommunicationRequest convertCommunicationRequest(org.hl7.fhir.dstu2.model.CommunicationRequest src) throws FHIRException {
        ...
        if (src.hasSender())
            tgt.addInformationProvider(Reference10_50.convertReference(src.getSender()));
        ...
        if (src.hasEncounter())
            tgt.setEncounter(Reference10_50.convertReference(src.getEncounter()));
        if (src.hasScheduled())
            tgt.setOccurrence(Type10_50.convertType(src.getScheduled()));
        ...
        if (src.hasRequestedOnElement())
            tgt.setAuthoredOnElement(DateTime10_50.convertDateTime(src.getRequestedOnElement()));
        if (src.hasSubject())
            tgt.setSubject(Reference10_50.convertReference(src.getSubject()));
        if (src.hasPriority())
            tgt.setPriority(convertPriorityCode(src.getPriority()));
