...
//      tgt.addClassHistory(convertClassHistoryComponent(t));
  ...
  static public org.hl7.fhir.r5.model.Enumeration<org.hl7.fhir.r5.model.Encounter.EncounterLocationStatus> convertEncounterLocationStatus(org.hl7.fhir.dstu3.model.Enumeration<org.hl7.fhir.dstu3.model.Encounter.EncounterLocationStatus> src) throws FHIRException {
      if (src == null || src.isEmpty())
          return null;
      Enumeration<Encounter.EncounterLocationStatus> tgt = new Enumeration<>(new Encounter.EncounterLocationStatusEnumFactory());
  ...
  static public org.hl7.fhir.r5.model.Enumeration<org.hl7.fhir.r5.model.Enumerations.EncounterStatus> convertEncounterStatus(org.hl7.fhir.dstu3.model.Enumeration<org.hl7.fhir.dstu3.model.Encounter.EncounterStatus> src) throws FHIRException {
      if (src == null || src.isEmpty())
          return null;
      Enumeration<Enumerations.EncounterStatus> tgt = new Enumeration<>(new Enumerations.EncounterStatusEnumFactory());
      ConversionContext30_50.INSTANCE.getVersionConvertor_30_50().copyElement(src, tgt);
      if (src.getValue() == null) {
          tgt.setValue(null);
      } else {
          switch (src.getValue()) {
              case PLANNED:
                  tgt.setValue(Enumerations.EncounterStatus.PLANNED);
                  break;
              case ARRIVED:
                  tgt.setValue(Enumerations.EncounterStatus.INPROGRESS);
                  break;
              case TRIAGED:
                  tgt.setValue(Enumerations.EncounterStatus.INPROGRESS);
                  break;
              ...
              case ONLEAVE:
                  ...
                  break;
              case FINISHED:
                  tgt.setValue(Enumerations.EncounterStatus.COMPLETED);
                  break;
              case CANCELLED:
                  tgt.setValue(Enumerations.EncounterStatus.CANCELLED);
                  break;
              case ENTEREDINERROR:
                  tgt.setValue(Enumerations.EncounterStatus.ENTEREDINERROR);
                  break;
              case UNKNOWN:
                  tgt.setValue(Enumerations.EncounterStatus.UNKNOWN);
                  break;
              default:
                  tgt.setValue(Enumerations.EncounterStatus.NULL);
                  break;
          }
      }
      return tgt;
