...
public class TerminologyClientNR4 implements ITerminologyClientN {
  
  public static class TerminologyClientR4Factory implements ITerminologyClientFactoryN {
    ...
    public ITerminologyClientN makeClientN(IModelContext context, String id, String url, String userAgent, ToolingClientLogger logger) throws URISyntaxException {
      return new TerminologyClientNR4(context, id, checkEndsWith("/r4", url), userAgent);
    }
  ...
  public TerminologyClientNR4(IModelContext context, String id, String address, String userAgent) throws URISyntaxException {
  ...
  public TerminologyClientNR4(IModelContext context, String id, String address, String userAgent, ClientHeaders clientHeaders) throws URISyntaxException {
    this.client = new FHIRToolingClient(address, userAgent);
  ...
  public ValueSet expandValueset(ValueSet vs, Parameters p) throws FHIRException {
    org.hl7.fhir.r4.model.ValueSet vs2 = vs == null ? null : (org.hl7.fhir.r4.model.ValueSet) convertResource("expandValueset", "request-params", vs);
    org.hl7.fhir.r4.model.Parameters p2 = p == null ? null :  (org.hl7.fhir.r4.model.Parameters) convertResource("expandValueset", "request-body", p);
    try {
  ...
  public Parameters getValueSetRelationship(ValueSet vsThis, ValueSet vsOther) throws IOException {
    ...
    org.hl7.fhir.r4.model.Parameters p2 = (org.hl7.fhir.r4.model.Parameters) VersionConvertorFactory_40_N.convertResource(pIn);
    return (Parameters) VersionConvertorFactory_40_N.convertResource(client.operateType(org.hl7.fhir.r4.model.ValueSet.class, "compare", p2));
  }
  ...
  public Parameters lookupCode(Parameters params) throws FHIRException {
    try {
      ...
      List<OperationOutcome> r5 = new ArrayList<OperationOutcome>();
  ...
  public CanonicalResource read(String type, String id) {
    ...
    Resource r4 = client.read(t, id);
    if (r4 == null) {
      throw new FHIRException("Unable to fetch resource " + Utilities.pathURL(getAddress(), type, id));
    }
    org.hl7.fhir.model.core.Resource rN = convertResource("read", "response", r4);
    if (rN == null) {
  ...
  @Override
  public ITerminologyClientN setClientHeaders(ClientHeaders clientHeaders) {
  ...
  private Resource convertResource(String name, String mode, org.hl7.fhir.model.core.Resource resource) {
    if (logger != null) {
      try {
        logger.log(name, mode, resource.fhirType(), "r5", new org.hl7.fhir.model.core.formats.JsonParser(context).setOutputStyle(OutputStyle.PRETTY).composeBytes(resource));
      } catch (IOException e) {
        throw new FHIRException(e);
      }
    }
    Resource res = VersionConvertorFactory_40_N.convertResource(resource);
    if (logger != null) {
      try {
        logger.log(name, mode, resource.fhirType(), "r4", new org.hl7.fhir.r4.formats.JsonParser().setOutputStyle(org.hl7.fhir.r4.formats.IParser.OutputStyle.PRETTY).composeBytes(res));
      } catch (IOException e) {
        throw new FHIRException(e);
      }
    }
  ...
  private org.hl7.fhir.model.core.Resource convertResource(String name, String mode, Resource resource) {
    if (logger != null && name != null) {
      try {
        logger.log(name, mode, resource.fhirType(), "r4", new org.hl7.fhir.r4.formats.JsonParser().setOutputStyle(org.hl7.fhir.r4.formats.IParser.OutputStyle.PRETTY).composeBytes(resource));
      } catch (IOException e) {
        throw new FHIRException(e);
      }
    }
    org.hl7.fhir.model.core.Resource res = VersionConvertorFactory_40_N.convertResource(resource);
    if (logger != null && name != null) {
      try {
        logger.log(name, mode, resource.fhirType(), "r5", new org.hl7.fhir.model.core.formats.JsonParser(context).setOutputStyle(OutputStyle.PRETTY).composeBytes(res));
      } catch (IOException e) {
        throw new FHIRException(e);
      }
    }
  ...
  public OperationOutcome validateResource(org.hl7.fhir.model.core.Resource res) {
    try {
      Resource r2 = convertResource("validate", "request", res);
