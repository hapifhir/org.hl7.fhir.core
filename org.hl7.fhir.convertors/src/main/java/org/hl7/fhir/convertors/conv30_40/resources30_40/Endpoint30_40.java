...
public class Endpoint30_40 {
    ...
    public static org.hl7.fhir.r4.model.Endpoint convertEndpoint(org.hl7.fhir.dstu3.model.Endpoint src) throws FHIRException {
        ...
        if (src.hasConnectionType())
            tgt.setConnectionType(Coding30_40.convertCoding(src.getConnectionType()));
        if (src.hasName())
        ...
        for (org.hl7.fhir.dstu3.model.CodeableConcept t : src.getPayloadType()) tgt.addPayloadType(CodeableConcept30_40.convertCodeableConcept(t));
    ...
    public static org.hl7.fhir.dstu3.model.Endpoint convertEndpoint(org.hl7.fhir.r4.model.Endpoint src) throws FHIRException {
        ...
        if (src.hasPeriod())
            tgt.setPeriod(Period30_40.convertPeriod(src.getPeriod()));
        for (org.hl7.fhir.r4.model.CodeableConcept t : src.getPayloadType()) tgt.addPayloadType(CodeableConcept30_40.convertCodeableConcept(t));
