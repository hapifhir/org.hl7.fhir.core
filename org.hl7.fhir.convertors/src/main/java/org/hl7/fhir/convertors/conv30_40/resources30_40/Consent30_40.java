...
public class Consent30_40 {
    ...
    static public org.hl7.fhir.r4.model.Consent convertConsent(org.hl7.fhir.dstu3.model.Consent src) throws FHIRException {
        ...
        for (org.hl7.fhir.dstu3.model.Reference t : src.getConsentingParty()) tgt.addPerformer(Reference30_40.convertReference(t));
        for (org.hl7.fhir.dstu3.model.Reference t : src.getOrganization()) tgt.addOrganization(Reference30_40.convertReference(t));
        if (src.hasSource())
        ...
        if (src.hasSecurityLabel() || src.hasPeriod() || src.hasActor() || src.hasAction() || src.hasPurpose() || src.hasDataPeriod() || src.hasData() || src.hasExcept()) {
            ...
            for (org.hl7.fhir.dstu3.model.CodeableConcept t : src.getAction()) pc.addAction(CodeableConcept30_40.convertCodeableConcept(t));
            for (org.hl7.fhir.dstu3.model.Coding t : src.getSecurityLabel()) pc.addSecurityLabel(Coding30_40.convertCoding(t));
    ...
    static public org.hl7.fhir.dstu3.model.Consent convertConsent(org.hl7.fhir.r4.model.Consent src) throws FHIRException {
        ...
        if (src.hasDateTime())
            tgt.setDateTimeElement(DateTime30_40.convertDateTime(src.getDateTimeElement()));
        for (org.hl7.fhir.r4.model.Reference t : src.getPerformer()) tgt.addConsentingParty(Reference30_40.convertReference(t));
        for (org.hl7.fhir.r4.model.Reference t : src.getOrganization()) tgt.addOrganization(Reference30_40.convertReference(t));
        if (src.hasSource())
            tgt.setSource(Type30_40.convertType(src.getSource()));
        ...
        if (src.hasProvision()) {
            ...
            for (org.hl7.fhir.r4.model.CodeableConcept t : p.getAction()) tgt.addAction(CodeableConcept30_40.convertCodeableConcept(t));
    ...
    static public org.hl7.fhir.dstu3.model.Consent.ExceptComponent convertExceptComponent(org.hl7.fhir.r4.model.Consent.provisionComponent src) throws FHIRException {
        ...
        for (org.hl7.fhir.r4.model.CodeableConcept t : src.getAction()) tgt.addAction(CodeableConcept30_40.convertCodeableConcept(t));
    ...
    static public org.hl7.fhir.r4.model.Consent.provisionComponent convertExceptComponent(org.hl7.fhir.dstu3.model.Consent.ExceptComponent src) throws FHIRException {
        ...
        for (org.hl7.fhir.dstu3.model.CodeableConcept t : src.getAction()) tgt.addAction(CodeableConcept30_40.convertCodeableConcept(t));
        ...
        for (org.hl7.fhir.dstu3.model.Coding t : src.getCode()) tgt.addCode(new CodeableConcept(Coding30_40.convertCoding(t)));
        if (src.hasDataPeriod())
            tgt.setDataPeriod(Period30_40.convertPeriod(src.getDataPeriod()));
