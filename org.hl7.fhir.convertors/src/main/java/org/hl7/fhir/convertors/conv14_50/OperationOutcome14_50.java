...
public class OperationOutcome14_50 {
    ...
    static public org.hl7.fhir.dstu2016may.model.OperationOutcome.IssueSeverity convertIssueSeverity(org.hl7.fhir.r5.model.OperationOutcome.IssueSeverity src) throws FHIRException {
        if (src == null)
            return null;
        switch(src) {
            case FATAL:
    ...
    static public org.hl7.fhir.r5.model.OperationOutcome.IssueSeverity convertIssueSeverity(org.hl7.fhir.dstu2016may.model.OperationOutcome.IssueSeverity src) throws FHIRException {
        if (src == null)
            return null;
        switch(src) {
            case FATAL:
    ...
    static public org.hl7.fhir.dstu2016may.model.OperationOutcome.IssueType convertIssueType(org.hl7.fhir.r5.model.OperationOutcome.IssueType src) throws FHIRException {
        if (src == null)
            return null;
        switch(src) {
            case INVALID:
    ...
    static public org.hl7.fhir.r5.model.OperationOutcome.IssueType convertIssueType(org.hl7.fhir.dstu2016may.model.OperationOutcome.IssueType src) throws FHIRException {
        if (src == null)
            return null;
        switch(src) {
            case INVALID:
    ...
    public static org.hl7.fhir.dstu2016may.model.OperationOutcome.OperationOutcomeIssueComponent convertOperationOutcomeIssueComponent(org.hl7.fhir.r5.model.OperationOutcome.OperationOutcomeIssueComponent src) throws FHIRException {
        ...
        if (src.hasDiagnostics())
            tgt.setDiagnosticsElement(VersionConvertor_14_50.convertString(src.getDiagnosticsElement()));
        for (org.hl7.fhir.r5.model.StringType t : src.getLocation()) tgt.addLocation(t.getValue());
        for (org.hl7.fhir.r5.model.StringType t : src.getExpression()) tgt.addExpression(VersionConvertor_14_50.convertTo2016MayExpression(t.getValue()));
        return tgt;
    }
    ...
    public static org.hl7.fhir.r5.model.OperationOutcome.OperationOutcomeIssueComponent convertOperationOutcomeIssueComponent(org.hl7.fhir.dstu2016may.model.OperationOutcome.OperationOutcomeIssueComponent src) throws FHIRException {
        ...
        for (org.hl7.fhir.dstu2016may.model.StringType t : src.getExpression()) tgt.addExpression(VersionConvertor_14_50.convertToR4Expression(t.getValue()));
        return tgt;
    }
}
