...
public class Type14_40 {
    ...
    public static org.hl7.fhir.dstu2016may.model.Type convertType(org.hl7.fhir.r4.model.Type src) throws FHIRException {
      ...
      if (src instanceof org.hl7.fhir.r4.model.CodeType) return Code14_40.convertCode((org.hl7.fhir.r4.model.CodeType) src);
      if (src instanceof org.hl7.fhir.r4.model.DateType) return Date14_40.convertDate((org.hl7.fhir.r4.model.DateType) src);
      ...
      if (src instanceof org.hl7.fhir.r4.model.TimeType) return Time14_40.convertTime((org.hl7.fhir.r4.model.TimeType) src);
      ...
      if (src instanceof org.hl7.fhir.r4.model.UuidType) return Uuid14_40.convertUuid((org.hl7.fhir.r4.model.UuidType) src);
      ...
      if (src instanceof org.hl7.fhir.r4.model.Coding) return Coding14_40.convertCoding((org.hl7.fhir.r4.model.Coding) src);
      if (src instanceof org.hl7.fhir.r4.model.Count) return Count14_40.convertCount((org.hl7.fhir.r4.model.Count) src);
      if (src instanceof org.hl7.fhir.r4.model.Distance) return Distance14_40.convertDistance((org.hl7.fhir.r4.model.Distance) src);
      if (src instanceof org.hl7.fhir.r4.model.Duration) return Duration14_40.convertDuration((org.hl7.fhir.r4.model.Duration) src);
      ...
      if (src instanceof org.hl7.fhir.r4.model.Period) return Period14_40.convertPeriod((org.hl7.fhir.r4.model.Period) src);
      if (src instanceof org.hl7.fhir.r4.model.Quantity) return Quantity14_40.convertQuantity((org.hl7.fhir.r4.model.Quantity) src);
      ...
      if (src instanceof org.hl7.fhir.r4.model.Address) return Address14_40.convertAddress((org.hl7.fhir.r4.model.Address) src);
