...
public class Type14_50 {
    public static org.hl7.fhir.r5.model.DataType convertType(org.hl7.fhir.dstu2016may.model.Type src) throws FHIRException {
      ...
      if (src instanceof org.hl7.fhir.dstu2016may.model.Age) return Age14_50.convertAge((org.hl7.fhir.dstu2016may.model.Age) src);
    ...
    public static org.hl7.fhir.dstu2016may.model.Type convertType(org.hl7.fhir.r5.model.DataType src) throws FHIRException {
      ...
      if (src instanceof org.hl7.fhir.r5.model.CodeType) return Code14_50.convertCode((org.hl7.fhir.r5.model.CodeType) src);
      if (src instanceof org.hl7.fhir.r5.model.DateType) return Date14_50.convertDate((org.hl7.fhir.r5.model.DateType) src);
      ...
      if (src instanceof org.hl7.fhir.r5.model.StringType) return String14_50.convertString((org.hl7.fhir.r5.model.StringType) src);
      if (src instanceof org.hl7.fhir.r5.model.TimeType) return Time14_50.convertTime((org.hl7.fhir.r5.model.TimeType) src);
      ...
      if (src instanceof org.hl7.fhir.r5.model.UuidType) return Uuid14_50.convertUuid((org.hl7.fhir.r5.model.UuidType) src);
      if (src instanceof org.hl7.fhir.r5.model.Extension) return Extension14_50.convertExtension((org.hl7.fhir.r5.model.Extension) src);
      if (src instanceof org.hl7.fhir.r5.model.Narrative) return Narrative14_50.convertNarrative((org.hl7.fhir.r5.model.Narrative) src);
      ...
      if (src instanceof org.hl7.fhir.r5.model.Coding) return Coding14_50.convertCoding((org.hl7.fhir.r5.model.Coding) src);
      if (src instanceof org.hl7.fhir.r5.model.Count) return Count14_50.convertCount((org.hl7.fhir.r5.model.Count) src);
      if (src instanceof org.hl7.fhir.r5.model.Distance) return Distance14_50.convertDistance((org.hl7.fhir.r5.model.Distance) src);
      if (src instanceof org.hl7.fhir.r5.model.Duration) return Duration14_50.convertDuration((org.hl7.fhir.r5.model.Duration) src);
      ...
      if (src instanceof org.hl7.fhir.r5.model.Period) return Period14_50.convertPeriod((org.hl7.fhir.r5.model.Period) src);
      if (src instanceof org.hl7.fhir.r5.model.Quantity) return Quantity14_50.convertQuantity((org.hl7.fhir.r5.model.Quantity) src);
      ...
      if (src instanceof org.hl7.fhir.r5.model.Reference) return Reference14_50.convertReference((org.hl7.fhir.r5.model.Reference) src);
      ...
      if (src instanceof org.hl7.fhir.r5.model.Signature) return Signature14_50.convertSignature((org.hl7.fhir.r5.model.Signature) src);
      if (src instanceof org.hl7.fhir.r5.model.Address) return Address14_50.convertAddress((org.hl7.fhir.r5.model.Address) src);
      ...
      if (src instanceof org.hl7.fhir.r5.model.HumanName) return HumanName14_50.convertHumanName((org.hl7.fhir.r5.model.HumanName) src);
      if (src instanceof org.hl7.fhir.r5.model.Meta) return Meta14_50.convertMeta((org.hl7.fhir.r5.model.Meta) src);
      if (src instanceof org.hl7.fhir.r5.model.Timing) return Timing14_50.convertTiming((org.hl7.fhir.r5.model.Timing) src);
      throw new FHIRException("Unknown type " + src.fhirType());
    }
}
