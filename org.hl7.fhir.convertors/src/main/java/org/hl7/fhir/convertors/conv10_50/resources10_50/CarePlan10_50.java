...
public class CarePlan10_50 {
    ...
    public static org.hl7.fhir.r5.model.CarePlan.CarePlanActivityComponent convertCarePlanActivityComponent(org.hl7.fhir.dstu2.model.CarePlan.CarePlanActivityComponent src) throws FHIRException {
        ...
        Element10_50.copyElement(src, tgt);
        for (org.hl7.fhir.dstu2.model.Annotation t : src.getProgress()) tgt.addProgress(Annotation10_50.convertAnnotation(t));
        if (src.hasReference())
    ...
    public static org.hl7.fhir.r5.model.CarePlan.CarePlanActivityPlannedActivityDetailComponent convertCarePlanActivityDetailComponent(org.hl7.fhir.dstu2.model.CarePlan.CarePlanActivityDetailComponent src) throws FHIRException {
        ...
        for (org.hl7.fhir.dstu2.model.CodeableConcept t : src.getReasonCode()) tgt.addReason(CodeableConcept10_50.convertCodeableConceptToCodableReference(t));
        ...
        if (src.hasScheduled())
            tgt.setScheduled(Type10_50.convertType(src.getScheduled()));
        if (src.hasLocation())
            tgt.getLocation().setReference(Reference10_50.convertReference(src.getLocation()));
        for (org.hl7.fhir.dstu2.model.Reference t : src.getPerformer()) tgt.addPerformer(Reference10_50.convertReference(t));
        if (src.hasProduct())
            tgt.setProduct(Type10_50.convertType(src.getProduct()));
