...
public class Appointment30_40 {
    ...
    public static org.hl7.fhir.r4.model.Appointment convertAppointment(org.hl7.fhir.dstu3.model.Appointment src) throws FHIRException {
        ...
        for (org.hl7.fhir.dstu3.model.Reference t : src.getIndication()) tgt.addReasonReference(Reference30_40.convertReference(t));
        if (src.hasPriority())
        ...
        for (org.hl7.fhir.dstu3.model.Period t : src.getRequestedPeriod()) tgt.addRequestedPeriod(Period30_40.convertPeriod(t));
        return tgt;
    }
    ...
    public static org.hl7.fhir.dstu3.model.Appointment convertAppointment(org.hl7.fhir.r4.model.Appointment src) throws FHIRException {
        ...
        for (org.hl7.fhir.r4.model.Reference t : src.getReasonReference()) tgt.addIndication(Reference30_40.convertReference(t));
        if (src.hasPriority())
            tgt.setPriorityElement(UnsignedInt30_40.convertUnsignedInt(src.getPriorityElement()));
        if (src.hasDescription())
            tgt.setDescriptionElement(String30_40.convertString(src.getDescriptionElement()));
        ...
        for (org.hl7.fhir.r4.model.Period t : src.getRequestedPeriod()) tgt.addRequestedPeriod(Period30_40.convertPeriod(t));
        return tgt;
    }
