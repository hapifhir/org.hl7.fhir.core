...
public class Timing10_50 {
    ...
    public static org.hl7.fhir.r5.model.Timing.TimingRepeatComponent convertTimingRepeatComponent(org.hl7.fhir.dstu2.model.Timing.TimingRepeatComponent src) throws FHIRException {
      ...
      Element10_50.copyElement(src, tgt);
      if (src.hasBounds()) tgt.setBounds(Type10_50.convertType(src.getBounds()));
      ...
      if (src.hasDurationMaxElement()) tgt.setDurationMaxElement(Decimal10_50.convertDecimal(src.getDurationMaxElement()));
