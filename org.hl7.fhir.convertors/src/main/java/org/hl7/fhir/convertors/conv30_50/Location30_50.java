...
public class Location30_50 {
    ...
    static public org.hl7.fhir.dstu3.model.Location.LocationMode convertLocationMode(org.hl7.fhir.r5.model.Location.LocationMode src) throws FHIRException {
        if (src == null)
            return null;
        switch(src) {
            case INSTANCE:
    ...
    static public org.hl7.fhir.r5.model.Location.LocationMode convertLocationMode(org.hl7.fhir.dstu3.model.Location.LocationMode src) throws FHIRException {
        if (src == null)
            return null;
        switch(src) {
            case INSTANCE:
    ...
    public static org.hl7.fhir.dstu3.model.Location.LocationPositionComponent convertLocationPositionComponent(org.hl7.fhir.r5.model.Location.LocationPositionComponent src) throws FHIRException {
        ...
        if (src.hasLongitudeElement())
            tgt.setLongitudeElement((org.hl7.fhir.dstu3.model.DecimalType) VersionConvertor_30_50.convertType(src.getLongitudeElement()));
        if (src.hasLatitudeElement())
            tgt.setLatitudeElement((org.hl7.fhir.dstu3.model.DecimalType) VersionConvertor_30_50.convertType(src.getLatitudeElement()));
        if (src.hasAltitudeElement())
            tgt.setAltitudeElement((org.hl7.fhir.dstu3.model.DecimalType) VersionConvertor_30_50.convertType(src.getAltitudeElement()));
        return tgt;
    }
    ...
    public static org.hl7.fhir.r5.model.Location.LocationPositionComponent convertLocationPositionComponent(org.hl7.fhir.dstu3.model.Location.LocationPositionComponent src) throws FHIRException {
        ...
        VersionConvertor_30_50.copyElement(src, tgt);
        if (src.hasLongitudeElement())
            tgt.setLongitudeElement((org.hl7.fhir.r5.model.DecimalType) VersionConvertor_30_50.convertType(src.getLongitudeElement()));
        if (src.hasLatitudeElement())
            tgt.setLatitudeElement((org.hl7.fhir.r5.model.DecimalType) VersionConvertor_30_50.convertType(src.getLatitudeElement()));
        if (src.hasAltitudeElement())
            tgt.setAltitudeElement((org.hl7.fhir.r5.model.DecimalType) VersionConvertor_30_50.convertType(src.getAltitudeElement()));
        return tgt;
    }

    static public org.hl7.fhir.dstu3.model.Location.LocationStatus convertLocationStatus(org.hl7.fhir.r5.model.Location.LocationStatus src) throws FHIRException {
        if (src == null)
            return null;
        switch(src) {
            case ACTIVE:
    ...
    static public org.hl7.fhir.r5.model.Location.LocationStatus convertLocationStatus(org.hl7.fhir.dstu3.model.Location.LocationStatus src) throws FHIRException {
        if (src == null)
            return null;
        switch(src) {
            case ACTIVE:
