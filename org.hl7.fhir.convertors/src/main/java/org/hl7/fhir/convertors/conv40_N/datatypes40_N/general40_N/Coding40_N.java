...
public class Coding40_N {
  public static org.hl7.fhir.model.core.Coding convertCoding(org.hl7.fhir.r4.model.Coding src) throws FHIRException {
    ...
    if (src.hasVersion()) tgt.setVersionElement(String40_N.convertString(src.getVersionElement()));
    ...
    if (src.hasUserSelected()) tgt.setUserSelectedElement(Boolean40_N.convertBoolean(src.getUserSelectedElement()));
    return tgt;
  }

  public static org.hl7.fhir.r4.model.Coding convertCoding(org.hl7.fhir.model.core.Coding src) throws FHIRException {
    if (src == null) return null;
  ...
  public static org.hl7.fhir.model.core.CodeableConcept convertCodingToCodeableConcept(org.hl7.fhir.r4.model.Coding src) throws FHIRException {
    if (src == null) return null;
  ...
  public static org.hl7.fhir.model.core.Coding convertCoding(org.hl7.fhir.r4.model.CodeableConcept src) throws FHIRException {
    if (src == null) return null;
    org.hl7.fhir.model.core.Coding tgt = new org.hl7.fhir.model.core.Coding();
    ConversionContext40_N.INSTANCE.getVersionConvertor_40_N().copyElement(src, tgt);
    if (src.hasCoding()) {
  ...
  public static org.hl7.fhir.r4.model.Coding convertCoding(org.hl7.fhir.model.core.CodeableConcept src) throws FHIRException {
    if (src == null) return null;
    org.hl7.fhir.r4.model.Coding tgt = new org.hl7.fhir.r4.model.Coding();
    ConversionContext40_N.INSTANCE.getVersionConvertor_40_N().copyElement(src, tgt);
    if (src.hasCoding()) {
