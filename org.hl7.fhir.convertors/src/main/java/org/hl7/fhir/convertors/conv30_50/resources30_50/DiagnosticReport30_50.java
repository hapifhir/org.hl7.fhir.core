...
public class DiagnosticReport30_50 {
    ...
    public static org.hl7.fhir.r5.model.DiagnosticReport convertDiagnosticReport(org.hl7.fhir.dstu3.model.DiagnosticReport src) throws FHIRException {
        ...
        for (org.hl7.fhir.dstu3.model.Reference t : src.getImagingStudy()) tgt.addImagingStudy(Reference30_50.convertReference(t));
        ...
        for (org.hl7.fhir.dstu3.model.CodeableConcept t : src.getCodedDiagnosis()) tgt.addConclusionCode(CodeableConcept30_50.convertCodeableConcept(t));
        for (org.hl7.fhir.dstu3.model.Attachment t : src.getPresentedForm()) tgt.addPresentedForm(Attachment30_50.convertAttachment(t));
        return tgt;
    }
    ...
    public static org.hl7.fhir.dstu3.model.DiagnosticReport convertDiagnosticReport(org.hl7.fhir.r5.model.DiagnosticReport src) throws FHIRException {
        ...
        for (org.hl7.fhir.r5.model.Reference t : src.getImagingStudy()) tgt.addImagingStudy(Reference30_50.convertReference(t));
        ...
        if (src.hasConclusion())
            tgt.setConclusionElement(String30_50.convertString(src.getConclusionElement()));
        for (org.hl7.fhir.r5.model.CodeableConcept t : src.getConclusionCode()) tgt.addCodedDiagnosis(CodeableConcept30_50.convertCodeableConcept(t));
        for (org.hl7.fhir.r5.model.Attachment t : src.getPresentedForm()) tgt.addPresentedForm(Attachment30_50.convertAttachment(t));
        return tgt;
    }
