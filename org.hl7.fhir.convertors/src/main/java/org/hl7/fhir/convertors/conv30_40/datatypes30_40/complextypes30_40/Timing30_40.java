...
public class Timing30_40 {
  ...
  public static org.hl7.fhir.r4.model.Timing.TimingRepeatComponent convertTimingRepeatComponent(org.hl7.fhir.dstu3.model.Timing.TimingRepeatComponent src) throws FHIRException {
    ...
    if (src.hasWhen())
      tgt.setWhen(src.getWhen().stream().map(Timing30_40::convertEventTiming).collect(Collectors.toList()));
  ...
  static public org.hl7.fhir.r4.model.Enumeration<org.hl7.fhir.r4.model.Timing.DayOfWeek> convertDayOfWeek(org.hl7.fhir.dstu3.model.Enumeration<org.hl7.fhir.dstu3.model.Timing.DayOfWeek> src) throws FHIRException {
    ...
    tgt.setValue(null);
      ...
      switch(src.getValue()) {
        case MON:
                    tgt.setValue(Timing.DayOfWeek.MON);
                    break;
                case TUE:
                    tgt.setValue(Timing.DayOfWeek.TUE);
                    break;
                case WED:
                    tgt.setValue(Timing.DayOfWeek.WED);
                    break;
                case THU:
                    tgt.setValue(Timing.DayOfWeek.THU);
                    break;
                case FRI:
                    tgt.setValue(Timing.DayOfWeek.FRI);
                    break;
                case SAT:
                    tgt.setValue(Timing.DayOfWeek.SAT);
                    break;
                case SUN:
                    tgt.setValue(Timing.DayOfWeek.SUN);
                    break;
                default:
                    tgt.setValue(Timing.DayOfWeek.NULL);
                    break;
       }
}
    return tgt;
