...
public class QuestionnaireResponse10_50 {
    ...
    public static org.hl7.fhir.dstu2.model.QuestionnaireResponse convertQuestionnaireResponse(org.hl7.fhir.r5.model.QuestionnaireResponse src) throws FHIRException {
        ...
        if (src.hasAuthoredElement())
            tgt.setAuthoredElement((org.hl7.fhir.dstu2.model.DateTimeType) VersionConvertor_10_50.convertType(src.getAuthoredElement()));
        if (src.hasSource()) {
    ...
    public static org.hl7.fhir.r5.model.QuestionnaireResponse convertQuestionnaireResponse(org.hl7.fhir.dstu2.model.QuestionnaireResponse src) throws FHIRException {
        ...
        if (src.hasAuthoredElement())
            tgt.setAuthoredElement((org.hl7.fhir.r5.model.DateTimeType) VersionConvertor_10_50.convertType(src.getAuthoredElement()));
        if (src.hasSource()) {
            tgt.setSource(VersionConvertor_10_50.convertReference(src.getSource()));
        }
        if (src.hasEncounter()) {
    ...
    public static org.hl7.fhir.r5.model.QuestionnaireResponse.QuestionnaireResponseStatus convertQuestionnaireResponseStatus(org.hl7.fhir.dstu2.model.QuestionnaireResponse.QuestionnaireResponseStatus src) throws FHIRException {
        if (src == null)
            return null;
        switch(src) {
            case INPROGRESS:
    ...
    public static org.hl7.fhir.dstu2.model.QuestionnaireResponse.QuestionnaireResponseStatus convertQuestionnaireResponseStatus(org.hl7.fhir.r5.model.QuestionnaireResponse.QuestionnaireResponseStatus src) throws FHIRException {
        if (src == null)
            return null;
        switch(src) {
            case INPROGRESS:
