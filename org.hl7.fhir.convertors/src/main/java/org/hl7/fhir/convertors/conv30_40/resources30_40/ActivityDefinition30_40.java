...
public class ActivityDefinition30_40 {
    ...
    public static org.hl7.fhir.dstu3.model.ActivityDefinition convertActivityDefinition(org.hl7.fhir.r4.model.ActivityDefinition src) throws FHIRException {
        ...
        for (org.hl7.fhir.r4.model.CanonicalType t : src.getLibrary()) tgt.addLibrary(Reference30_40.convertCanonicalToReference(t));
        if (src.hasKind())
        ...
        for (org.hl7.fhir.r4.model.CodeableConcept t : src.getBodySite()) tgt.addBodySite(CodeableConcept30_40.convertCodeableConcept(t));
        if (src.hasTransform())
