...
{{generated}}
public class {{jname}}XmlParser extends org.hl7.fhir.model.core.formats.XmlParser {

  public {{jname}}XmlParser(IModelContext modelContext, boolean allowUnknownContent) {
    super(modelContext);
    setAllowUnknownContent(allowUnknownContent);
  }

  public {{jname}}XmlParser(IModelContext modelContext, IXMLWriter xml) {
    super(modelContext);
    this.xml = xml;
  }
