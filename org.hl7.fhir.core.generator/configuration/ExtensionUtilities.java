...
public class ExtensionUtilities {
  ...
  //      else
  //        dr.getExtensionList().add(Factory.newExtension(url, new StringType(content), true));
  //    }
  //  }
  ...
  public static void addMarkdownExtension(DomainResource dr, String url, String content) {
    if (!StringUtils.isBlank(content)) {
      ...
      if (ex != null)
        ...
        dr.getExtensionList().add(Factory.newExtension(url, new MarkdownType(content), true));
    }
  }
  ...
  public static void addStringExtension(Element e, String url, String content) {
    if (!StringUtils.isBlank(content)) {
      ...
      if (ex != null)
        ...
        e.getExtensionList().add(Factory.newExtension(url, new StringType(content), true));
    }
  }
  ...
  public static void addCodeExtension(Element e, String url, String content) {
    if (!StringUtils.isBlank(content)) {
      ...
      if (ex != null)
        ...
        e.getExtensionList().add(Factory.newExtension(url, new CodeType(content), true));
    }
  }
  ...
  public static void addBooleanExtension(Element e, String url, boolean content) {
    ...
    if (ex != null)
      ...
      e.getExtensionList().add(Factory.newExtension(url, new BooleanType(content), true));
  }
  ...
  public static void addIntegerExtension(DomainResource dr, String url, int value) {
    ...
    if (ex != null)
      ...
      dr.getExtensionList().add(Factory.newExtension(url, new IntegerType(value), true));
  }
  ...
  public static void addCodeExtension(DomainResource dr, String url, String value) {
    ...
    if (ex != null)
      ...
      dr.getExtensionList().add(Factory.newExtension(url, new CodeType(value), true));
  }

  public static void addVSComment(ValueSet.ConceptSetComponent nc, String comment) {
    if (!StringUtils.isBlank(comment))
      nc.getExtensionList().add(Factory.newExtension(ExtensionDefinitions.EXT_VS_COMMENT, Factory.newString_(comment), true));
  }
  ...
  public static void addDefinition(Element nc, String definition) {
    if (!StringUtils.isBlank(definition))
      nc.getExtensionList().add(Factory.newExtension(ExtensionDefinitions.EXT_DEFINITION, Factory.newString_(definition), true));
  }

  public static void addDisplayHint(Element def, String hint) {
    if (!StringUtils.isBlank(hint))
      def.getExtensionList().add(Factory.newExtension(ExtensionDefinitions.EXT_DISPLAY_HINT, Factory.newString_(hint), true));
  }
  ...
  public static void addFlyOver(Questionnaire.QuestionnaireItemComponent item, String text, String linkId){
    if (!StringUtils.isBlank(text)) {
      ...
      display.getExtensionList().add(Factory.newExtension(ExtensionDefinitions.EXT_CONTROL, Factory.newCodeableConcept("flyover", "http://hl7.org/fhir/questionnaire-item-control", "Fly-over"), true));
    }
  }

  public static void addMin(Questionnaire.QuestionnaireItemComponent item, int min) {
    item.getExtensionList().add(Factory.newExtension(ExtensionDefinitions.EXT_MINOCCURS, Factory.newInteger(min), true));
  }

  public static void addMax(Questionnaire.QuestionnaireItemComponent item, int max) {
    item.getExtensionList().add(Factory.newExtension(ExtensionDefinitions.EXT_MAXOCCURS, Factory.newInteger(max), true));
  }

  public static void addFhirType(Questionnaire.QuestionnaireItemComponent group, String value) {
    group.getExtensionList().add(Factory.newExtension(ExtensionDefinitions.EXT_FHIRTYPE, Factory.newString_(value), true));
  }

  public static void addControl(Questionnaire.QuestionnaireItemComponent group, String value) {
    group.getExtensionList().add(Factory.newExtension(ExtensionDefinitions.EXT_CONTROL, Factory.newCodeableConcept(value, "http://hl7.org/fhir/questionnaire-item-control", value), true));
  }

  public static void addAllowedResource(Questionnaire.QuestionnaireItemComponent group, String value) {
    group.getExtensionList().add(Factory.newExtension(ExtensionDefinitions.EXT_ALLOWEDRESOURCE, Factory.newCode(value), true));
  }

  public static void addReferenceFilter(Questionnaire.QuestionnaireItemComponent group, String value) {
    group.getExtensionList().add(Factory.newExtension(ExtensionDefinitions.EXT_REFERENCEFILTER, Factory.newString_(value), true));
  }

  //  public static void addIdentifier(Element element, Identifier value) {
  //    element.getExtensionList().add(Factory.newExtension(ExtensionDefinitions.EXT_IDENTIFIER, value, true));
  //  }
  ...
  public static Extension getExtension(DomainResource resource, String name) {
    ...
    if (!resource.hasExtension())
      return null;
    for (Extension e : resource.getExtensionList()) {
  ...
  public static Extension getExtension(Element el, String name) {
    ...
    if (!el.hasExtension())
      return null;
    for (Extension e : el.getExtensionList()) {
      if (name.equals(e.getUrl()))
        return e;
    }
    return null;
  ...
  public static void setStringExtension(DomainResource resource, String uri, String value) {
    ...
    if (ext != null)
      ...
      resource.getExtensionList().add(new Extension(uri).setValue(new StringType(value)));
  }
  ...
  public static void setUriExtension(DomainResource resource, String uri, String value) {
    ...
    if (ext != null)
      ...
      resource.getExtensionList().add(new Extension(uri).setValue(new UriType(value)));
  }
  ...
  public static void setCanonicalExtension(DomainResource resource, String uri, String value) {
    ...
    if (ext != null)
      ...
      resource.getExtensionList().add(new Extension(uri).setValue(new CanonicalType(value)));
  }
  ...
  public static void setUrlExtension(DomainResource resource, String uri, String value) {
    ...
    if (ext != null)
      ...
      resource.getExtensionList().add(new Extension(uri).setValue(new UrlType(value)));
  }
  ...
  public static void setCodeExtension(DomainResource resource, String uri, String value) {
    ...
    if (ext != null)
      ...
      resource.getExtensionList().add(new Extension(uri).setValue(new CodeType(value)));
  }
  ...
  public static void setCodeExtensionMod(DomainResource resource, String uri, String value) {
    ...
    if (ext != null)
      ...
      resource.getModifierExtensionList().add(new Extension(uri).setValue(new CodeType(value)));
  }
  ...
  public static void setCodeExtension(Element element, String uri, String value) {
    ...
    if (ext != null)
      ...
      element.getExtensionList().add(new Extension(uri).setValue(new CodeType(value)));
  }
  ...
  public static void setMarkdownExtension(DomainResource resource, String uri, String value) {
    ...
    if (ext != null)
      ...
      resource.getExtensionList().add(new Extension(uri).setValue(new MarkdownType(value)));
  }
  ...
  public static void setIntegerExtension(DomainResource resource, String uri, int value) {
    ...
    if (ext != null)
      ...
      resource.getExtensionList().add(new Extension(uri).setValue(new IntegerType(value)));
  }
  ...
  //    define.getExtensionList().add(Factory.newExtension(ExtensionDefinitions.EXT_OID, Factory.newUri(oid), false));
  ...
  //    vs.getExtensionList().add(Factory.newExtension(ExtensionDefinitions.EXT_OID, Factory.newUri(oid), false));
  ...
  public static boolean hasLanguageTranslations(Element element) {
    for (Extension e : element.getExtensionList()) {
  ...
  public static void addLanguageTranslation(Element element, String lang, String value) {
    ...
    element.getExtensionList().add(extension);
  }
  ...
  public static void setLanguageTranslation(Element element, String lang, String value) {
    ...
    for (Extension extension : element.getExtensionList()) {
  ...
  public static void removeLanguageTranslation(Element element, String lang) {
    ...
    for (Extension extension : element.getExtensionList()) {
      if (ExtensionDefinitions.EXT_TRANSLATION.equals(extension.getUrl())) {
        String l = extension.getExtensionString("lang");
        if (lang.equals(l)) {
          element.getExtensionList().remove(extension);
          return;
        }
      }
    }
  ...
  public static boolean hasAllowedUnits(ElementDefinition eld) {
    for (Extension e : eld.getExtensionList())
  ...
  public static void setAllowableUnits(ElementDefinition eld, CodeableConcept cc) {
    ...
    eld.getExtensionList().add(new Extension().setUrl(ExtensionDefinitions.EXT_ALLOWABLE_UNITS).setValue(cc));
  }

  public static List<Extension> getExtensions(Element element, String url) {
    List<Extension> results = new ArrayList<Extension>();
    for (Extension ex : element.getExtensionList())
  ...
  public static List<Extension> getExtensions(DomainResource resource, String url) {
    List<Extension> results = new ArrayList<Extension>();
    for (Extension ex : resource.getExtensionList())
      if (ex.getUrl().equals(url))
        results.add(ex);
    return results;
  }
  ...
  //    for (Extension e : de.getExtensionList())
  //      if (e.getUrl().equals(ExtensionDefinitions.EXT_CIMI_REFERENCE)) {
  //        e.setValue(new UriType(value));
  //        return;
  //      }
  //    de.getExtensionList().add(new Extension().setUrl(ExtensionDefinitions.EXT_CIMI_REFERENCE).setValue(new UriType(value)));
  //  }

  //  public static void setDeprecated(Element nc) {
  //    for (Extension e : nc.getExtensionList())
  //      if (e.getUrl().equals(ExtensionDefinitions.EXT_DEPRECATED)) {
  //        e.setValue(new BooleanType(true));
  //        return;
  //      }
  //    nc.getExtensionList().add(new Extension().setUrl(ExtensionDefinitions.EXT_DEPRECATED).setValue(new BooleanType(true)));
  //  }

  public static void setExtension(Element focus, String url, Coding c) {
    for (Extension e : focus.getExtensionList())
      if (e.getUrl().equals(url)) {
        e.setValue(c);
        return;
      }
    focus.getExtensionList().add(new Extension().setUrl(url).setValue(c));
  }

  public static void removeExtension(DomainResource focus, String url) {
    Iterator<Extension> i = focus.getExtensionList().iterator();
    while (i.hasNext()) {
  ...
  public static ValidationMessage readValidationMessage(OperationOutcome.OperationOutcomeIssueComponent issue, ValidationMessage.Source source) {
    ...
    if (issue.hasExpression())
      vm.setLocation(issue.getExpressionList().get(0).asStringValue());
  ...
  private static ValidationMessage.IssueType mapType(org.hl7.fhir.model.core.OperationOutcome.IssueType code) {
    if (code == null) {
      return null;
    }
    switch (code) {
  ...
  private static ValidationMessage.IssueSeverity mapSeverity(org.hl7.fhir.model.core.OperationOutcome.IssueSeverity severity) {
    if (severity == null) {
      return null;
    }
    switch (severity) {
  ...
  public static void addUrlExtension(Element e, String url, String value) {
    ...
    if (ex != null)
      ...
      e.getExtensionList().add(Factory.newExtension(url, new UrlType(value), true));
  }
  ...
  public static void addUrlExtension(DomainResource dr, String url, String value) {
    ...
    if (ex != null)
      ...
      dr.getExtensionList().add(Factory.newExtension(url, new UrlType(value), true));
  }
  ...
  public static void addUriExtension(Element e, String url, String value) {
    ...
    if (ex != null)
      ...
      e.getExtensionList().add(Factory.newExtension(url, new UriType(value), true));
  }
  ...
  public static void addUriExtension(DomainResource dr, String url, String value) {
    ...
    if (ex != null)
      ...
      dr.getExtensionList().add(Factory.newExtension(url, new UriType(value), true));
  }
  ...
  public static void addCanonicalExtension(Element e, String url, String value) {
    ...
    if (ex != null)
      ...
      e.getExtensionList().add(Factory.newExtension(url, new CanonicalType(value), true));
  ...
  public static void addCanonicalExtension(DomainResource dr, String url, String value) {
    ...
    if (ex != null)
      ...
      dr.getExtensionList().add(Factory.newExtension(url, new CanonicalType(value), true));
  }
  ...
  public static boolean hasExtensionValue(StructureDefinition src, String url, String value) {
    for (Extension ext : src.getExtensionList()) {
  ...
  private static Extension setExtensionE(Element context, String url, DataType value) {
    for (Extension ext : context.getExtensionList()) {
  ...
  private static Extension setExtensionBE(BackboneElement context, boolean mod, String url, DataType value) {
    if (mod) {
      for (Extension ext : context.getModifierExtensionList()) {
        if (ext.getUrl().equals(url)) {
          return ext.setValue(value);
        }
      }
  ...
  private static List<Extension> getAllExtensions(Base context, String url) {
    ...
    if (mod) {
      if (context instanceof BackboneElement) {
        list.addAll(((BackboneElement) context).getModifierExtensionList());
      }
      if (context instanceof BackboneType) {
        list.addAll(((BackboneElement) context).getModifierExtensionList());
      }
      if (context instanceof DomainResource) {
        list.addAll(((DomainResource) context).getModifierExtensionList());
      }
    } else {
      if (context instanceof Element) {
        list.addAll(((Element) context).getExtensionList());
      }
      if (context instanceof DomainResource) {
        list.addAll(((DomainResource) context).getExtensionList());
      }
    }
    return list;
  }
  ...
  public static boolean stripExtensions(Element element, List<String> exceptions) {
    boolean res = element.getExtensionList().removeIf(ex -> !exceptions.contains(ex.getUrl()));
  ...
  public static VersionResolutionRules getVersionResolutionRules(Element element) {
    if (element == null) {
...
//    if (base instanceof org.hl7.fhir.model.elementmodel.Element) {
//      return getVersionResolutionRules((org.hl7.fhir.model.elementmodel.Element) base);
//    } else
