...
public class CapabilityStatementUtilities {
  ...
  public CapabilityStatement resolveImports(CapabilityStatement targetCS) throws FHIRException {
    CapabilityStatement resolvedCS = targetCS.copy(Base64BinaryType.COPY_DATA);
  ...
  public CapabilityStatement resolveImports(CapabilityStatement targetCS, Map<String, String> importedUrls, String conformance) throws FHIRException {
    ...
    CapabilityStatement resolvedCS = targetCS.copy(Base64BinaryType.COPY_DATA);
    for (CanonicalType canonical: resolvedCS.getImportsList()) {
  ...
  protected void mergeCS(CapabilityStatement targetCS, CapabilityStatement importedCS, String maxConformance) {
    merge(targetCS.getFormatList(), importedCS.getFormatList(), maxConformance, "format");
    merge(targetCS.getPatchFormatList(), importedCS.getPatchFormatList(), maxConformance, "patchFormat");
    merge(targetCS.getAcceptLanguageList(), importedCS.getAcceptLanguageList(), maxConformance, "acceptLanguage");
    merge(targetCS.getImplementationGuideList(), importedCS.getImplementationGuideList(), maxConformance, "implementationGuide");
    merge(targetCS.getRestList(), importedCS.getRestList(), maxConformance, "rest");
    if (targetCS.getMessagingList().size()>1)
    ...
    else if (importedCS.getMessagingList().size()>1)
      ...
      targetCS.setMessagingList(importedCS.getMessagingList());
    else {
      CapabilityStatement.CapabilityStatementMessagingComponent targetMessaging = targetCS.getMessagingList().get(0);
      CapabilityStatement.CapabilityStatementMessagingComponent importedMessaging = importedCS.getMessagingList().get(0);
      ...
      merge(targetMessaging.getSupportedMessageList(), importedMessaging.getSupportedMessageList(), maxConformance, "messaging.supportedMessage");
    }
    merge(targetCS.getMessagingList(), importedCS.getMessagingList(), maxConformance, "messaging");
    merge(targetCS.getDocumentList(), importedCS.getDocumentList(), maxConformance, "messaging");
  }
  ...
  void mergeProperties(CapabilityStatement.CapabilityStatementRestComponent targetType, CapabilityStatement.CapabilityStatementRestComponent importedType, String maxConformance, String context) {
    ...
    merge(targetType.getResourceList(), importedType.getResourceList(), maxConformance, localContext + ".resource");
    merge(targetType.getInteractionList(), importedType.getInteractionList(), maxConformance, localContext + ".interaction");
    merge(targetType.getOperationList(), importedType.getOperationList(), maxConformance, localContext + ".operation");
    merge(targetType.getSearchParamList(), importedType.getSearchParamList(), maxConformance, localContext + ".searchParam");
  }
  ...
  void mergeProperties(CapabilityStatement.CapabilityStatementRestSecurityComponent targetType, CapabilityStatement.CapabilityStatementRestSecurityComponent importedType, String maxConformance, String context) {
    ...
    merge(targetType.getServiceList(), importedType.getServiceList(), maxConformance, context + ".service");
  }
  ...
  void mergeProperties(CapabilityStatement.CapabilityStatementRestResourceComponent targetType, CapabilityStatement.CapabilityStatementRestResourceComponent importedType, String maxConformance, String context) throws FHIRException {
    ...
    merge(targetType.getSupportedProfileList(), importedType.getSupportedProfileList(), maxConformance, localContext + ".supportedProfile");
    ...
    merge(targetType.getReferencePolicyList(), importedType.getReferencePolicyList(), maxConformance, localContext + ".referencePolicy");
    merge(targetType.getSearchIncludeList(), importedType.getSearchIncludeList(), maxConformance, localContext + ".searchInclude");
    merge(targetType.getSearchRevIncludeList(), importedType.getSearchRevIncludeList(), maxConformance, localContext + ".searchRevInclude");
    merge(targetType.getSearchParamList(), importedType.getSearchParamList(), maxConformance, localContext + ".searchParam");
    merge(targetType.getOperationList(), importedType.getOperationList(), maxConformance, localContext + ".operation");
  }
  ...
  void mergeProperties(CapabilityStatement.CapabilityStatementMessagingComponent targetType, CapabilityStatement.CapabilityStatementMessagingComponent importedType, String maxConformance, String context) throws FHIRException {
    ...
    merge(targetType.getSupportedMessageList(), importedType.getSupportedMessageList(), maxConformance, context + ".reliableCache");
  }
  ...
  private boolean match(CodeableConcept a, CodeableConcept b) {
    if (a.hasText() || b.hasText())
      if (a.hasText()!= b.hasText() || !a.getText().equals(b.getText()))
        return false;
    if (a.getCodingList().size()!= b.getCodingList().size())
      return false;
    for (Coding codeA: a.getCodingList()) {
      boolean codingMatch = false;
      for (Coding codeB: b.getCodingList()) {
