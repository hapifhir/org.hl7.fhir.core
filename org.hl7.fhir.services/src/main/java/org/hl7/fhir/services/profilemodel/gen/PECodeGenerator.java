  ...
  private class PEGenClass {
    ...
    private String generateEnum(PEDefinition source, PEDefinition field) {
      if (field.definition().hasBinding() && !field.hasFixedValue()) {
        ...
        if (binding.getStrength() == org.hl7.fhir.model.core.Enumerations.BindingStrength.REQUIRED && binding.hasValueSet()) {
          org.hl7.fhir.model.core.ValueSet vs = workerContext.fetchResource(org.hl7.fhir.model.core.ValueSet.class, binding.getValueSet(),
          ...
          if (vs != null) {
            ...
            if (vse.isOk()) {
              ...
              for (int i = 0; i < vse.getValueset().getExpansion().getContainsList().size(); i++) {
                ValueSetExpansionContainsComponent cc = vse.getValueset().getExpansion().getContainsList().get(i);
                ...
                w(enums, "    "+code+(i < vse.getValueset().getExpansion().getContainsList().size() - 1 ? "," : ";")+" // \""+cc.getDisplay()+"\" = "+cc.getSystem()+"#"+cc.getCode());
              }
              w(enums, "");
              if (!hasDups) {
