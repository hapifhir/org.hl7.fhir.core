...
public class Resolver {
  ...
  public static class ResourceContext {
    ...
    Resource resource;
    org.hl7.fhir.context.elementmodel.Element element;
    ...
    public ResourceContext(ResourceContext container, org.hl7.fhir.context.elementmodel.Element dr) {
      super();
      this.container = container;
      this.element = dr;
    }
...
//    }
    ...
    //    public org.hl7.fhir.context.elementmodel.Element getBundleElement() {
...
//
    ...
    public org.hl7.fhir.context.elementmodel.Element getElement() {
      return element;
    }
    ...
    public org.hl7.fhir.context.elementmodel.Element resolveElement(String value, String version) {
      if (value.startsWith("#")) {
        if (element != null) {
          for (org.hl7.fhir.context.elementmodel.Element r : element.getChildrenByName("contained")) {
      ...
      if (element != null) {
        if (element.fhirType().equals("Bundle")) {
          for (org.hl7.fhir.context.elementmodel.Element be : element.getChildren("entry")) {
            org.hl7.fhir.context.elementmodel.Element res = be.getNamedChild("resource");
            if (res != null) { 
        ...
        if (element.fhirType().equals("Parameters")) {
          for (org.hl7.fhir.context.elementmodel.Element p : element.getChildren("parameter")) {
            org.hl7.fhir.context.elementmodel.Element res = p.getNamedChild("resource");
    ...
    private boolean checkVersion(String version, org.hl7.fhir.context.elementmodel.Element res) {
      if (version == null) {
        return true;
      } else if (!res.hasChild("meta")) {
        return false;
      } else {
        org.hl7.fhir.context.elementmodel.Element meta = res.getNamedChild("meta");
