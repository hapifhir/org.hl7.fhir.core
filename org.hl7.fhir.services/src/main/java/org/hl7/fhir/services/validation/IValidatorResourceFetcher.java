...
public interface IValidatorResourceFetcher {
  ...
  boolean resolveURL(IResourceValidator validator, Object appContext, String path, String url, VersionResolutionRules rules, String type, boolean canonical, List<CanonicalType> targets) throws IOException, FHIRException;
  ...
  public static class ResourceVersionInformation {
    ...
    public static Set<String> toStrings(Set<ResourceVersionInformation> possibleVersions) {
      Set<String> result = new HashSet<>();
      for (ResourceVersionInformation v : possibleVersions) {
