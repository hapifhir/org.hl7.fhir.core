...
public interface IContextResourceLoaderN {
  /** 
   ...
   */
  IContextResourceLoaderN getNewLoader(NpmPackage npm) throws JsonSyntaxException, IOException;
   ...
   * @return
   */
  IContextResourceLoaderN setLoadProfiles(boolean value);
  
  /**
   * @return the terminology client factory
   */
  ITerminologyClientFactoryN txFactory();
