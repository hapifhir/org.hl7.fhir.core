...
public class ValueSetExpansionOutcome {
  ...
  public ValueSetExpansionOutcome(String error, TerminologyServiceErrorClass errorClass, List<String> errList, boolean fromServer, String msgId, OpIssueCode code) {
    this.valueset = null;
    this.error = error;
    this.errorClass = errorClass;
    this.fromServer = fromServer;
