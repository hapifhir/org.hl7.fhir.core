...
import org.hl7.fhir.model.client.Client;
import org.hl7.fhir.model.client.FHIRToolingClient;
import org.hl7.fhir.model.client.ResourceRequest;
...
class FHIRToolingClientTest {
  ...
  private Bundle generateBundle() {
    ...
    observation.setSubject(new Reference(null, patient.getIdElement().getValue()));
