...
import org.hl7.fhir.services.renderers.utils.ResourceWrapper.ElementKind;
...
public class ResourceElementTests {
  ...
  public void testIndirectBundleXml() throws FHIRFormatError, IOException {
    IWorkerContext worker = TestingUtilities.getSharedWorkerContext();
    List<ValidatedFragment> res = Manager.parse(worker, TestingUtilities.loadTestResourceStream("r6", "bundle-resource-element-test.xml"), FhirFormat.XML);
  ...
  public void testIndirectBundleJson() throws FHIRFormatError, IOException {
    IWorkerContext worker = TestingUtilities.getSharedWorkerContext();
    List<ValidatedFragment> res = Manager.parse(worker, TestingUtilities.loadTestResourceStream("r6", "bundle-resource-element-test.json"), FhirFormat.JSON);
    ResourceWrapper re = ResourceWrapper.forResource(new ContextUtilities(worker), res.get(0).getElement());
    checkTree(re);
  }
  ...
  public void testIndirectObservationXml() throws FHIRFormatError, IOException {
    IWorkerContext worker = TestingUtilities.getSharedWorkerContext();
    List<ValidatedFragment> res = Manager.parse(worker, TestingUtilities.loadTestResourceStream("r6", "obs-resource-element-test.xml"), FhirFormat.XML);
    ResourceWrapper re = ResourceWrapper.forResource(new ContextUtilities(worker), res.get(0).getElement());
    checkObservation(re, false, "Observation");
  }
  ...
  public void testIndirectObservationJson() throws FHIRFormatError, IOException {
    IWorkerContext worker = TestingUtilities.getSharedWorkerContext();
    List<ValidatedFragment> res = Manager.parse(worker, TestingUtilities.loadTestResourceStream("r6", "obs-resource-element-test.json"), FhirFormat.JSON);
    ResourceWrapper re = ResourceWrapper.forResource(new ContextUtilities(worker), res.get(0).getElement());
    checkObservation(re, false, "Observation");
  }
