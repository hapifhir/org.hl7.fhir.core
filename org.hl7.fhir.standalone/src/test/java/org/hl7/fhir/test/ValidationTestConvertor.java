...
public class ValidationTestConvertor {
  ...
  public static void main(String[] args) throws FileNotFoundException, IOException, FHIRException {
    SimpleWorkerContext context = new SimpleWorkerContext.SimpleWorkerContextBuilder(ModelContext.fullCoreContext()).fromPack("C:\\work\\org.hl7.fhir\\build\\publish\\validation-min.xml.zip");
