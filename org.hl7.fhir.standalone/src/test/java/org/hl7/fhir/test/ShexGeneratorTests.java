...
import org.hl7.fhir.services.conformance.ShExGeneratorBase;
import org.hl7.fhir.services.conformance.ShExGeneratorConfig;
import org.hl7.fhir.services.conformance.ShExGeneratorR6;
...
public class ShexGeneratorTests {
  ...
  /** Generate complete ShEx schema from default org.hl7.fhir.services context of StructureDefinitions */
  @Test
      ...
      try (InputStream is = ManagedFileAccess.inStream(filePath)) {
        Resource resource = parser.parse(is);
          if (resource instanceof StructureDefinition) {
              ...
              for (Bundle.BundleEntryComponent entry : bundle.getEntryList()) {
