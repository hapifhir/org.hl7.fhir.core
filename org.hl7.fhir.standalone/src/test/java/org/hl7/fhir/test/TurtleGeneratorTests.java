...
import org.hl7.fhir.services.elementmodel.ParserBase.IdRenderingPolicy;
...
public class TurtleGeneratorTests {
  ...
  private static final Path DEFAULT_EXPECTED_TTL_DIR = ROOT_TEST_PATH.resolve("ttl/examples/expected");
    // These can be overwritten with a local.properties file (org.hl7.fhir.services/src/test/resources/local.properties)
  ...
  public static void setup() throws IOException {
    ...
    // Override configured directories in org.hl7.fhir.services/src/test/resources/local.properties
  ...
  private static TurtleGeneratorTestUtils.ParserContext createVersionOverrideParsers(String version) {
    ...
    System.out.println("FHIR version for testing: " + context.getFHIRVersion());
...
//  }
  ...
  public void syncR6ParserStateCoversAllParserBaseSettings() {
    ...
    Set<String> ignored = Set.of("context", "profileUtilities", "contextUtilities", "setElementsToIgnore");
  ...
  void testSharedWorkerContextProvidesLoincNamingSystem() {
    ...
    assertThat(namingSystem.getUniqueIdList()).anySatisfy(uniqueId -> {
  ...
  void testR6CodeableConceptCanDeriveConceptIriFromNamingSystemWhenEnabled() throws Exception {
    TurtleGeneratorTestUtils.ParserContext parserContext = TurtleGeneratorTestUtils.ParserContext.fromWorkerContext(r6ContextWithTestNamingSystem());
  ...
  private String generateObservationCodeableConcept(TurtleGeneratorTestUtils.ParserContext parserContext, String system, String code) throws IOException, UcumException {
    String xml = """
  ...
  private String testInstanceGeneration(TurtleGeneratorTestUtils.ParserContext parserContext, Path resourcePath, Path outputDirectory) throws IOException, UcumException {
