...
public class FHIRPathParserTests {
  ...
  void testFhirPathParserLexerIndexer() {
    ...
    Assertions.assertEquals(org.hl7.fhir.services.fhirpath.ExpressionNode.Kind.Name, opName.getKind());
    ...
    Assertions.assertEquals(org.hl7.fhir.services.fhirpath.ExpressionNode.Function.Item, opIndexer.getFunction());
    ...
    Assertions.assertEquals(org.hl7.fhir.services.fhirpath.ExpressionNode.Operation.Union, opIndexer.getOperation());
    ...
    Assertions.assertEquals(org.hl7.fhir.services.fhirpath.ExpressionNode.Kind.Name, opRight.getKind());
  ...
  void testFhirPathParserLexerOperator() {
    ...
    Assertions.assertEquals(org.hl7.fhir.services.fhirpath.ExpressionNode.Kind.Constant, opLeft.getKind());
    ...
    Assertions.assertEquals(org.hl7.fhir.services.fhirpath.ExpressionNode.Operation.In, opLeft.getOperation());
    ...
    Assertions.assertEquals(org.hl7.fhir.services.fhirpath.ExpressionNode.Kind.Constant, opRight.getKind());
    Assertions.assertEquals(1, opRight.getEnd().getLine());
  ...
  void testFhirPathParserLexerConstantBoolean() {
    ...
    Assertions.assertEquals(org.hl7.fhir.services.fhirpath.ExpressionNode.Kind.Constant, constantNode.getKind());
  ...
  void testFhirPathParserLexerConstantQuantity() {
    ...
    var quantity = (org.hl7.fhir.model.core.Quantity) constantNode.getConstant();
  ...
  void testFhirPathParserLexerConstantBooleanInBrackets() {
    ...
    Assertions.assertEquals(org.hl7.fhir.services.fhirpath.ExpressionNode.Kind.Group, groupNode.getKind());
