...
import org.hl7.fhir.model.core.MedicinalProductDefinition;
import org.hl7.fhir.standalone.testing.TestPackageLoader;
import org.hl7.fhir.standalone.testing.TestingUtilities;
import org.hl7.fhir.test.profiles.codegen.DkCoreDeCprIdentifier;
import org.hl7.fhir.test.profiles.codegen.DkCorePatient;
import org.hl7.fhir.test.profiles.codegen.MedicinalProductDefinitionUvEpi;
...
/**
 * The files in org.hl7.fhir.services.test.profiles.codegen are generated 
 * by running the validator with these parameters:
 * 
 *   -codegen -version R5 -ig hl7.fhir.dk.core#3.2.0 -ig hl7.fhir.uv.emedicinal-product-info#1.0.0 -profiles http://hl7.dk/fhir/core/StructureDefinition/* -output /Users/grahamegrieve/work/core/org.hl7.fhir.services/src/test/java/org/hl7/fhir/r5/test/profiles -package-name org.hl7.fhir.services.test.profiles -profiles http://hl7.org/fhir/uv/emedicinal-product-info/StructureDefinition/*
 * 
...
public class PECodeGenTests {
  ...
  public void load() throws IOException {
    if (ctxt == null) {
      ...
      TestPackageLoader loader = new TestPackageLoader(Utilities.stringSet("StructureDefinition", "ValueSet", "CodeSystem"), ctxt);
