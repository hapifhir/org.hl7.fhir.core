...
public class SnomedExpressionsTests {
  ...
  public void test() throws FHIRException {
    ...
    p("243796009|situation with explicit context|:246090004|associated finding|=    (64572001|disease|:{116676008|associated morphology|=72704001|fracture|,"
        + "    363698007|finding site|=(12611008|bone structure of tibia|:    272741003|laterality|=7771000|left|)}),408729009|finding context|=    "
    ...
    p("71388002 |procedure| : {260686004 |method| = 129304002 |excision - action|, 405813007 |procedure site - direct| = 28231008 |gallbladder structure|}, {260686004 |method| = 281615006 "
        + "|exploration|, 405813007 |procedure site - direct| = 28273000 |bile duct structure|}");
    p("27658006 |amoxicillin|:411116001 |has dose form| = 385049006 |capsule|,{ 127489000 |has active ingredient| = 372687004 |amoxicillin|,111115 |has basis of strength| = (111115 |"
        + "amoxicillin only|:111115 |strength magnitude| = #500,111115 |strength unit| = 258684004 |mg|)}");
    p("91143003 |albuterol|:411116001 |has dose form| = 385023001 |oral solution|,{ 127489000 |has active ingredient| = 372897005 |albuterol|,111115 |has basis of strength| = (111115 |a"
        + "lbuterol only|:111115 |strength magnitude| = #0.083,111115 |strength unit| = 118582008 |%|)}");
    ...
    // from Overview of Expression Normalization, Equivalence and Subsumption
    // Testing
    ...
    // p("10925361000119108 |Closed fracture of shaft of left tibia|"); // US
    // Extension
