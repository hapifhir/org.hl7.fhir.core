...
public class InstanceValidatorOptionsConvertorTest {
  ...
  public static Stream<Arguments> validOptions() {
    return Stream.of(
      ...
      Arguments.arguments(
        "jurisdiction (global)",
        new InstanceValidatorOptions().withJurisdiction("global"),
        new InstanceValidatorParameters().setJurisdiction("http://unstats.un.org/unsd/methods/m49/m49.htm#001")
      ),
      ...
      Arguments.arguments(
        ...
        new InstanceValidatorOptions().withLevel("error"),
