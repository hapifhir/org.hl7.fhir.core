...
public class TestGenerationDataGeneratorRN implements IPackageVisitorProcessor {
  ...
  public void processResource(PackageContext ctxt, Object context, String type, String id, byte[] content) throws FHIRException, IOException {
    ...
    if (worker == null) {
      ...
      IContextResourceLoaderN loader = ContextResourceLoaderFactory.makeLoaderN(worker.getModelContext(), ctxt.getNpm().fhirVersion(), new NullLoaderKnowledgeProviderRN());
      SimpleWorkerContext swc = new SimpleWorkerContext.SimpleWorkerContextBuilder(worker.getModelContext()).withAllowLoadingDuplicates(true).fromPackage(npm, loader, true);
  ...
  public static void main(String[] args) throws Exception {
    new TestGenerationDataGeneratorRN().execute();
