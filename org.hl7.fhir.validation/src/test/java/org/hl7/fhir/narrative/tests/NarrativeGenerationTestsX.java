...
public class NarrativeGenerationTestsX {
  ...
  private static Map<String, IWorkerContext> contexts = new HashMap<String, IWorkerContext>();
  ...
  public static Stream<Arguments> data() throws ParserConfigurationException, IOException, FHIRFormatError, SAXException {
    Document tests = XMLUtil.parseToDom(TestingUtilities.loadTestResource("rX", "narrative", "manifest.xml"));
