  ...
  public void testLoad() {
    assertDoesNotThrow(() -> {
      ...
      int DO_TIMES = 10;
        ...
        byte[] b = FileUtilities.streamToBytes(TestingUtilities.loadTestResourceStream("r4b", "snapshot-generation", "t34-expected.xml")); // yes the choice of R5 is deliberate here - it's the same content as R4.
        for (int i = 0; i < DO_TIMES; i++) {
          System.gc();
