...
public class ValidationEngineTests {
  ...
  public void testCurrentXml() throws Exception {
    ...
    ValidationEngine ve = new ValidationEngine("hl7.fhir.r4.core#4.0.1", DEF_TX, null, null, FhirPublication.R4, "4.0.1");
  ...
  public void test140() throws Exception {
    ...
    ValidationEngine ve = new ValidationEngine("hl7.fhir.r2b.core#1.4.0", DEF_TX, null, null,FhirPublication.DSTU2016May, "1.4.0");
  ...
  public void test102() throws Exception {
    ...
    ValidationEngine ve = new ValidationEngine("hl7.fhir.r2.core#1.0.2", DEF_TX, null, null, FhirPublication.DSTU2, "1.0.2");
    ve.setNoInvariantChecks(true);
  ...
  public void test301() throws Exception {
    ...
    ValidationEngine ve = new ValidationEngine("hl7.fhir.r3.core#3.0.2", DEF_TX, null, null, FhirPublication.STU3, "3.0.2");
    if (!TestUtilities.silent)
