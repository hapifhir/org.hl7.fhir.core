...
class TestInstanceGenerationTester {
  ...
  void testDataFactory() throws IOException, FHIRException {
    ...
    for (String name : Utilities.strings("Patient-1.json","Patient2-1.json", "Encounter-1.json", "MedicationStatement-1.json", "Observation-bp-1.json", "Observation-weight-1.json", "Patient3-1.json", "Binary-1.json", "BinaryRejected-1.json", "Patient5-1.json")) {
    ...
    for (String name : Utilities.strings("Bundle-patients.json", "Encounter-1.json", "Encounter-2.json", "Encounter-3.json", "Encounter-4.json", "MedicationStatement-1.json", 
        ...
        "Patient-1.json", "Patient-2.json", "Patient-3.json", "Patient-4.json", "Patient2-1.json", "Patient2-2.json", "Patient2-3.json", "Patient3-1.json", "Binary-1.json", "BinaryRejected-1.json", "Patient5-1.json")) {
