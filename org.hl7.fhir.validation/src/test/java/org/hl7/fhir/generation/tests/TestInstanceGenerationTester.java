...
class TestInstanceGenerationTester {
  ...
  void testDataFactory() throws IOException, FHIRException {
    ...
    context.connectToTSServer(new TerminologyClientR4.TerminologyClientR4Factory(), "https://tx-dev.fhir.org", "Instance-Generator", Utilities.path("[tmp]", "tx-log.html"), false);
