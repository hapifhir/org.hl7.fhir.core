...
public final class ParamNames  {
  ...
  public static final String QUESTIONNAIRE_MODE = "questionnaireMode";
  public static final String LEVEL = "level";
  public static final String BEST_PRACTICE_LEVEL = "bestPracticeLevel";
  public static final String HTML_IN_MARKDOWN_CHECK = "htmlInMarkdownCheck";
  ...
  public static final String SHOW_MESSAGES_FROM_REFERENCES = "showMessagesFromReferences";
  ...
  public static final String SHOW_TERMINOLOGY_ROUTING = "showTerminologyRouting";
  public static final String DO_IMPLICIT_FHIR_PATH_STRING_CONVERSION = "doImplicitFHIRPathStringConversion";
