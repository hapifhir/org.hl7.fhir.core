...
public class Definitions {
  ...
  // the packages (id#version) these definitions were loaded from. Only used for the header comment
  // on generated files, so that a reader can see where the code actually came from
