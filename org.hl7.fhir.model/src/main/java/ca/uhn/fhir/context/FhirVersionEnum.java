...
public enum FhirVersionEnum {
  ...
  /**
   * This class actually returns an IFhirVersion. The onus is on the caller to cast the object to IFhirVersion.
   *
   * @return IFhirVersion
   */
	...
	//IANTORNO FIXME move static method to FhirContext class
