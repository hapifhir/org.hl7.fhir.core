...
public class SimpleWorkerContextTests {
  ...
  public void testValidateCodingWithCache() throws IOException {
    ...
    Mockito.doReturn(cacheToken).when(terminologyCache).generateValidationToken(validationOptions, coding, valueSet, new Parameters());
  ...
  public void testValidateCodableConceptWithCache() throws IOException {
    ...
    Mockito.doReturn(cacheToken).when(terminologyCache).generateValidationToken(CacheTestUtils.validationOptions, codeableConcept, valueSet, new Parameters());
    Mockito.doReturn(expectedValidationResult).when(terminologyCache).getValidation(cacheToken);
  ...
  public void testValidateCodableConceptWithServer() throws IOException {
    ...
    Mockito.doReturn(cacheToken).when(terminologyCache).generateValidationToken(validationOptions, codeableConcept, valueSet, new Parameters());
