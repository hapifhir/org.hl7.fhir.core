...
public interface IWorkerContextManager {
   ...
   * @param loader - an implementation of IContextResourceLoader that knows how to read the resources in the package (e.g. for the appropriate version).
   ...
   */
  int loadFromPackage(NpmPackage pi, IContextResourceLoader loader, boolean isMaster) throws IOException, FHIRException;

  default int loadFromPackage(NpmPackage pi, IContextResourceLoader loader) throws IOException, FHIRException {
  ...
  default int loadPackage(NpmPackage pi) throws IOException, FHIRException {
   ...
   * @return the number of resources loaded
   */
  int loadFromPackageAndDependencies(NpmPackage pi, IContextResourceLoader loader, BasePackageCacheManager pcm) throws IOException, FHIRException;
