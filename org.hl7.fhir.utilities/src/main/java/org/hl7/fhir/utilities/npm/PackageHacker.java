...
/**
 * internal use only - set the file name to edit in main(), and fill out the edit routine
 *
 * @author grahame
 */
public class PackageHacker {

  private static boolean useSecureReferences = true;

  public static void main(String[] args) throws IOException {
    new PackageHacker().edit("M:\\web\\hl7.org\\fhir\\2021Mar\\hl7.fhir.r4b.expansions.tgz");
  }

  private void edit(String name) throws IOException {
